...
目次
1. [まえがき](#1-まえがき)
    - [1.1. opensource COBOLとは](#11-opensource-cobolとは)
    - [1.2. COBOL/opensource COBOLの重要機能](#12-cobolopensource-cobolの重要機能)
        - [1.2.1. COBOL プログラムの構文](#121-cobolプログラムの構文)
        - [1.2.2. コピーブック](#122-コピーブック)
        - [1.2.3. 構造化データ](#123-構造化データ)
        - [1.2.4. ファイル](#124-ファイル)
        - [1.2.5. 表操作](#125-表操作)
        - [1.2.6. データの並び替えと結合](#126-データの並び替えと結合)
        - [1.2.7. 文字列操作](#127-文字列操作)
        - [1.2.8. テキストユーザインターフェース(TUI)機能](#128-テキストユーザインターフェースtui機能)
    - [1.3. 構文規則](#13-構文規則)
    - [1.4. ソースコードの形式](#14-ソースコードの形式)
    - [1.5. カンマ/セミコロンの使い方](#15-カンマセミコロンの使い方)
    - [1.6. COPY文の使い方](#16-copy文の使い方)
    - [1.7. 定数の使い方](#17-定数の使い方)
        - [1.7.1. 数字定数](#171-数字定数)
        - [1.7.2. 英数字定数](#172-英数字定数)
        - [1.7.3. 日本語定数](#173-日本語定数)
    - [1.8. 表意定数の使い方](#18-表意定数の使い方)
    - [1.9. ユーザ定義名](#19-ユーザ定義名)
    - [1.10. LENGTH OFの使い方](#110-length-ofの使い方)
2. [opensource COBOLのプログラム形式](#2-opensource-cobolのプログラム形式)
    - [2.1. ネストされたユーザプログラム](#21-ネストされたユーザプログラム)
    - [2.2. ネストされたユーザ定義関数](#22-ネストされたユーザ定義関数)
3. [見出し部](#3-見出し部)
4. [環境部](#4-環境部)
    - [4.1. 構成節](#41-構成節)
        - [4.1.1. 翻訳用計算機段落](#411-翻訳用計算機段落)
        - [4.1.2. 実行用計算機段落](#412-実行用計算機段落)
        - [4.1.3. リポジトリ段落](#413-リポジトリ段落)
        - [4.1.4. 特殊名段落](#414-特殊名段落)
    - [4.2. 入出力節](#42-入出力節)
        - [4.2.1. ファイル管理段落](#421-ファイル管理段落)
            - [4.2.1.1. 順編成ファイル](#4211-順編成ファイル)
            - [4.2.1.2. 相対編成ファイル](#4212-相対編成ファイル)
            - [4.2.1.3. 索引編成ファイル](#4213-索引編成ファイル)
        - [4.2.2. 入出力管理段落](#422-入出力管理段落)
5. [データ部](#5-データ部)
    - [5.1. ファイル記述](#51-ファイル記述)
    - [5.2. 整列用記述](#52-整列用記述)
    - [5.3. データ記述の形式](#53-データ記述の形式)
    - [5.4. 条件名](#54-条件名)
    - [5.5. 定数記述](#55-定数記述)
    - [5.6. 画面記述](#56-画面記述)
6. [手続き部](#6-手続き部)
    - [6.1. 構成要素](#61-構成要素)
        - [6.1.1. 表の参照](#611-表の参照)
        - [6.1.2. データ名の修飾](#612-データ名の修飾)
        - [6.1.3. 部分参照](#613-部分参照)
        - [6.1.4. 式](#614-式)
            - [6.1.4.1. 算術式](#6141-算術式)
            - [6.1.4.2. 条件式](#6142-条件式)
        - [6.1.5. ピリオド(.)](#615-ピリオド)
        - [6.1.6. 動詞/END-動詞](#616-動詞end-動詞)
        - [6.1.7. 特殊レジスタ](#617-特殊レジスタ)
        - [6.1.8. ファイルへの同時アクセス制御](#618-ファイルへの同時アクセス制御)
            - [6.1.8.1. ファイル共有](#6181-ファイル共有)
            - [6.1.8.2. レコードロック](#6182-レコードロック)
    - [6.2. 記述形式](#62-記述形式)
    - [6.3. 宣言の記述形式](#63-宣言の記述形式)
    - [6.4. ACCEPT](#64-accept)
        - [6.4.1. ACCEPT文の書き方 1 ― コンソールからの読み取り](#641-accept文の書き方1--コンソールからの読み取り)
        - [6.4.2. ACCEPT文の書き方 2 ― コマンドライン引数の取得](#642-accept文の書き方2--コマンドライン引数の取得)
        - [6.4.3. ACCEPT文の書き方 3 ― 環境変数値の取得](#643-accept文の書き方3--環境変数値の取得)
        - [6.4.4. ACCEPT文の書き方 4 ― 画面データの取得](#644-accept文の書き方4--画面データの取得)
        - [6.4.5. ACCEPT文の書き方 5 ― 日付/時刻の取得](#645-accept文の書き方5--日付時刻の取得)
        - [6.4.6. ACCEPT文の書き方 6 ― 画面サイズデータの取得](#646-accept文の書き方6--画面サイズデータの取得)
        - [6.4.7. ACCEPT文の例外処理](#647-accept文の例外処理)
    - [6.5. ADD](#65-add)
        - [6.5.1. ADD文の書き方 1 ― ADD TO](#651-add文の書き方1add-to)
        - [6.5.2. ADD文の書き方 2 ― ADD GIVING](#652-add文の書き方2--add-giving)
        - [6.5.3. ADD文の書き方 3 ― ADD CORRESPONDING](#653-add文の書き方3--add-corresponding)
    - [6.6. ALLOCATE](#66-allocate)
    - [6.7. CALL](#67-call)
    - [6.8. CANCEL](#68-cancel)
        - [6.8.1. CANCEL文の書き方 1 ― CANCEL](#681-cancel文の書き方1--cancel)
        - [6.8.2. CANCEL文の書き方 2 ― CANCEL ALL](#682-cancel文の書き方2--cancel-all)
    - [6.9. CLOSE](#69-close)
    - [6.10. COMMIT](#610-commit)
    - [6.11. COMPUTE](#611-compute)
    - [6.12. CONTINUE](#612-continue)
    - [6.13. DELETE](#613-delete)
        - [6.13.1. DELETE文の書き方 1 ― DELETE](#6131-delete文の書き方1--delete)
        - [6.13.2. DELETE文の書き方 2 ― DELETE FILE](#6132-delete文の書き方2--delete-file)
    - [6.14. DISPLAY](#614-display)
        - [6.14.1. DISPLAY文の書き方 1 ― UPON CONSOLE](#6141-display文の書き方1--upon-console)
        - [6.14.2. DISPLAY文の書き方 2 ― コマンドライン引数へのアクセス](#6142-display文の書き方2--コマンドライン引数へのアクセス)
        - [6.14.3. DISPLAY文の書き方 3 ― 環境変数へのアクセスまたは設定](#6143-display文の書き方3--環境変数へのアクセスまたは設定)
        - [6.14.4. DISPLAY文の書き方 4 ― 画面データ](#6144-display文の書き方4--画面データ)
        - [6.14.5. DISPLAY文の例外処理](#6145-display文の例外処理)
    - [6.15. DIVIDE](#615-divide)
        - [6.15.1. DIVIDE文の書き方 1 ― DIVIDE INTO](#6151-divide文の書き方1--divide-into)
        - [6.15.2. DIVIDE文の書き方 2 ― DIVIDE INTO GIVING](#6152-divide文の書き方2--divide-into-giving)
        - [6.15.3. DIVIDE文の書き方 3 ― DIVIDE BY GIVING](#6153-divide文の書き方3--divide-by-giving)
        - [6.15.4. DIVIDE文の書き方 4 ― DIVIDE INTO REMAINDER](#6154-divide文の書き方4--divide-into-remainder)
        - [6.15.5. DIVIDE文の書き方 5 ― DIVIDE BY REMAINDER](#6155-divide文の書き方5--divide-by-remainder)
    - [6.16. ENTRY](#616-entry)
    - [6.17. EVALUATE](#617-evaluate)
    - [6.18. EXIT](#618-exit)
    - [6.19. FREE](#619-free)
    - [6.20. GENERATE](#620-generate)
    - [6.21. GOBACK](#621-goback)
    - [6.22. GO TO](#622-go-to)
        - [6.22.1. GO TO文の書き方 1 ― GO TO](#6221-go-to文の書き方1--go-to)
        - [6.22.2. GO TO文の書き方 2 ― GO TO DEPENDING ON](#6222-go-to文の書き方2--go-to-depending-on)
    - [6.23. IF](#623-if)
    - [6.24. INITIALIZE](#624-initialize)
    - [6.25. INITIATE](#625-initiate)
    - [6.26. INSPECT](#626-inspect)
    - [6.27. MERGE](#627-merge)
    - [6.28. MOVE](#628-move)
        - [6.28.1. MOVE文の書き方 1 ― MOVE](#6281-move文の書き方1--move)
        - [6.28.2. MOVE文の書き方 2 ― MOVE CORRESPONDING](#6282-move文の書き方2--move-corresponding)
    - [6.29. MULTIPLY](#629-multiply)
        - [6.29.1. MULTIPLY文の書き方 1 ― MULTIPLY BY](#6291-multiply文の書き方1--multiply-by)
        - [6.29.2. MULTIPLY文の書き方 2 ― MULTIPLY GIVING](#6292-multiply文の書き方2--multiply-giving)
    - [6.30. NEXT SENTENCE](#630-next-sentence)
    - [6.31. OPEN](#631-open)
    - [6.32. PERFORM](#632-perform)
        - [6.32.1. PERFORM文の書き方 1 ― 手続き型](#6321-perform文の書き方1--手続き型)
        - [6.32.2. PERFORM文の書き方 2 ― インライン型](#6322-perform文の書き方2--インライン型)
    - [6.33. READ](#633-read)
        - [6.33.1. READ文の書き方 1 ― 順次読み取り](#6331-read文の書き方1--順次読み取り)
        - [6.33.2. READ文の書き方 2 ― ランダム読み取り](#6332-read文の書き方2--ランダム読み取り)
    - [6.34. RELEASE](#634-release)
    - [6.35. RETURN](#635-return)
    - [6.36. REWRITE](#636-rewrite)
    - [6.37. ROLLBACK](#637-rollback)
    - [6.38. SEARCH](#638-search)
        - [6.38.1. SEARCH文の書き方 1 ― 順次探索](#6381-search文の書き方1--順次探索)
        - [6.38.2. SEARCH文の書き方 2 ― 二分探索(SEARCH ALL)](#6382-search文の書き方2--二分探索search-all)
    - [6.39. SET](#639-set)
        - [6.39.1. SET文の書き方 1 ― 環境設定](#6391-set文の書き方1--環境設定)
        - [6.39.2. SET文の書き方 2 ― プログラムポインター設定](#6392-set文の書き方2--プログラムポインター設定)
        - [6.39.3. SET文の書き方 3 ― アドレス設定](#6393-set文の書き方3--アドレス設定)
        - [6.39.4. SET文の書き方 4 ― インデックス設定](#6394-set文の書き方4--インデックス設定)
        - [6.39.5. SET文の書き方 5 ― UP/DOWN設定](#6395-set文の書き方5--updown-設定)
        - [6.39.6. SET文の書き方 6 ― 条件名設定](#6396-set文の書き方6--条件名設定)
        - [6.39.7. SET文の書き方 7 ― スイッチ設定](#6397-set文の書き方7--スイッチ設定)
    - [6.40. SORT](#640-sort)  
        - [6.40.1. SORT文の書き方 1 ― ファイルソート](#6401-sort文の書き方1--ファイルソート)
        - [6.40.2. SORT文の書き方 2 ― テーブルソート](#6402-sort文の書き方2--テーブルソート)
    - [6.41. START](#641-start)
    - [6.42. STOP](#642-stop)
    - [6.43. STRING](#643-string)
    - [6.44. SUBTRACT](#644-subtract)
        - [6.44.1. SUBTRACT文の書き方 1 ― SUBTRACT FROM](#6441-subtract文の書き方1--subtract-from)
        - [6.44.2. SUBTRACT文の書き方 2 ― SUBTRACT GIVING](#6442-subtract文の書き方2--subtract-giving)
        - [6.44.3. SUBTRACT文の書き方 3 ― SUBTRACT CORRESPONDING](#6443-subtract文の書き方3--subtract-corresponding)
    - [6.45. SUPPRESS](#645-suppress)
    - [6.46. TERMINATE](#646-terminate)
    - [6.47. TRANSFORM](#647-transform)
    - [6.48. UNLOCK](#648-unlock)
    - [6.49. UNSTRING](#649-unstring)
    - [6.50. WRITE](#650-write)
7. [日本語の使用](#7-日本語の使用)
    - [7.1. 英数字項目の日本語](#71-英数字項目の日本語)
    - [7.2. 日本語項目と表意定数](#72-日本語項目と表意定数)
    - [7.3. 各命令文と日本語の取扱い](#73-各命令文と日本語の取扱い)
        - [7.3.1. MOVE文](#731-move文)
        - [7.3.2. ACCEPT/DISPLAY文](#732-acceptdisplay文)
    - [7.4. UTF-8の使用](#74-utf-8の使用)
8. [opensource COBOLシステムインターフェース](#8-opensource-cobolシステムインターフェース)
    - [8.1. opensource COBOL コンパイラの使い方(cobc)](#81-opensource-cobolコンパイラの使い方cobc)
        - [8.1.1. 解説](#811-解説)
        - [8.1.2. コンパイルオプション](#812-コンパイルオプション)
        - [8.1.3. 実行可能プログラムのコンパイル](#813-実行可能プログラムのコンパイル)
        - [8.1.4. 動的にロード可能なサブプログラム](#814-動的にロード可能なサブプログラム)
        - [8.1.5. 静的サブルーチン](#815-静的サブルーチン)
        - [8.1.6. COBOLとCプログラムの結合](#816-cobolとcプログラムの結合)
            - [8.1.6.1. opensource COBOLランタイムライブラリの要件](#8161-opensource-cobolランタイムライブラリの要件)
            - [8.1.6.2. opensource COBOLとCの文字列割り当ての違い](#8162-opensource-cobolとcの文字列割り当ての違い)
            - [8.1.6.3. Cデータ型とopensource COBOL USAGE句の一致](#8163-cデータ型とopensource-cobol-usage句の一致)
            - [8.1.6.4. opensource COBOLメインプログラムのCサブプログラム呼び出し](#8164-opensource-cobolメインプログラムのcサブプログラム呼び出し)
            - [8.1.6.5. Cメインプログラムのopensource COBOLサブプログラム呼び出し](#8165-c-メインプログラムのopensource-cobolサブプログラム呼び出し)
        - [8.1.7. 重要な環境変数](#817-重要な環境変数)
        - [8.1.8. コンパイル時のコピーブックの検索](#818-コンパイル時のコピーブックの検索)
        - [8.1.9. コンパイラ構成ファイルの使い方](#819-コンパイラ構成ファイルの使い方)
    - [8.2. opensource COBOLプログラムの実行](#82-opensource-cobolプログラムの実行)
        - [8.2.1. プログラムの直接実行](#821-プログラムの直接実行)
        - [8.2.2. 「cobcrun」ユーティリティの使用](#822-cobcrunユーティリティの使用)
        - [8.2.3. プログラムの引数](#823-プログラムの引数)
        - [8.2.4. 重要な環境変数](#824-重要な環境変数)
    - [8.3. 組み込みサブルーチン](#83-組み込みサブルーチン)
        - [8.3.1. 「名前による呼び出し」ルーチン](#831-名前による呼び出しルーチン)
            - [8.3.1.1. CALL “C$CALLEDBY” USING program-name GIVING status](#8311-call-ccalledby-using-program-name-giving-status)
            - [8.3.1.2. CALL “C$CHDIR” USING directory-path, result](#8312-call-cchdir-using-directory-path-result)
            - [8.3.1.3. CALL “C$COPY” USING src-file-path, dest-file-path, 0](#8313-call-ccopy-using-src-file-path-dest-file-path-0)
            - [8.3.1.4. CALL “C$DELETE” USING file-path, 0](#8314-call-cdelete-using-file-path-0)
            - [8.3.1.5. CALL “C$FILEINFO” USING file-path, file-info](#8315-call-cfileinfo-using-file-path-file-info)
            - [8.3.1.6. CALL “C$JUSTIFY” USING data-item, “justification-type”](#8316-call-cjustify-using-data-item-justification-type)
            - [8.3.1.7. CALL “C$LIST-DIRECTORY” USING item-1, item-2, item-3](#8317-call-clist-directory-using-item-1-item-2-item-3)
            - [8.3.1.8. CALL “C$MAKEDIR” USING dir-path](#8318-call-cmakedir-using-dir-path)
            - [8.3.1.9. CALL “C$NARG” USING arg-count-result](#8319-call-cnarg-using-arg-count-result)
            - [8.3.1.10. CALL “C$PARAMSIZE” USING argument-number](#83110-call-cparamsize-using-argument-number)
            - [8.3.1.11. CALL “C$SLEEP” USING seconds-to-sleep](#83111-call-csleep-using-seconds-to-sleep)
            - [8.3.1.12. CALL “C$TOLOWER” USING data-item, BY VALUE convert-length](#83112-call-ctolower-using-data-item-by-value-convert-length)
            - [8.3.1.13. CALL “C$TOUPPER” USING data-item, BY VALUE convert-length](#83113-call-ctoupper-using-data-item-by-value-convert-length)
            - [8.3.1.14. CALL “CBL_AND” USING item-1, item-2, BY VALUE byte-length](#83114-call-cbl_and-using-item-1-item-2-by-value-byte-length)
            - [8.3.1.15. CALL “CBL_CHANGE_DIR” USING directory-path](#83115-call-cbl_change_dir-using-directory-path)
            - [8.3.1.16. CALL “CBL_CHECK_FILE_EXIST” USING file-path, file-info](#83116-call-cbl_check_file_exist-using-file-path-file-info)
            - [8.3.1.17. CALL “CBL_CHANGE_DIR” USING directory-path](#83117-call-cbl_change_dir-using-directory-path)
            - [8.3.1.18. CALL “CBL_COPY_FILE” USING src-file-path, dest-file-path](#83118-call-cbl_copy_file-using-src-file-path-dest-file-path)
            - [8.3.1.19. CALL “CBL_CREATE_DIR” USING dir-path](#83119-call-cbl_create_dir-using-dir-path)
            - [8.3.1.20. CALL “CBL_CREATE_FILE” USING file-path, 2, 0, 0, file-handle](#83120-call-cbl_create_file-using-file-path-2-0-0-file-handle)
            - [8.3.1.21. CALL “CBL_DELETE_DIR” USING dir-path](#83121-call-cbl_delete_dir-using-dir-path)
            - [8.3.1.22. CALL “CBL_DELETE_FILE” USING file-path](#83122-call-cbl_delete_file-using-file-path)
            - [8.3.1.23. CALL “CBL_ERROR_PROC” USING function, program-pointer](#83123-call-cbl_error_proc-using-function-program-pointer)
            - [8.3.1.24. CALL “CBL_EXIT_PROC” USING function, program-pointer](#83124-call-cbl_exit_proc-using-function-program-pointer)
            - [8.3.1.25. CALL “CBL_EQ” USING item-1, item-2, BY VALUE byte-length](#83125-call-cbl_eq-using-item-1-item-2-by-value-byte-length)
            - [8.3.1.26. CALL “CBL_FLUSH_FILE” USING file-handle](#83126-call-cbl_flush_file-using-file-handle)
            - [8.3.1.27. CALL “CBL_GET_CURRENT_DIR” USING BY VALUE 0, BY VALUE length, BY REFERENCE buffer](#83127-call-cbl_get_current_dir-using-by-value-0-by-value-length-by-reference-buffer)
            - [8.3.1.28. CALL “CBL_IMP” USING item-1, item-2, BY VALUE byte-length](#83128-call-cbl_imp-using-item-1-item-2-by-value-byte-length)
            - [8.3.1.29. CALL “CBL_NIMP” USING item-1, item-2, BY VALUE byte-length](#83129-call-cbl_nimp-using-item-1-item-2-by-value-byte-length)
            - [8.3.1.30. CALL “CBL_NOR” USING item-1, item-2, BY VALUE byte-length](#83130-call-cbl_nor-using-item-1-item-2-by-value-byte-length)
            - [8.3.1.31. CALL “CBL_NOT” USING item-1, BY VALUE byte-length](#83131-call-cbl_not-using-item-1-by-value-byte-length)
            - [8.3.1.32. CALL “CBL_OC_KEISEN” USING item-1](#83132-call-cbl_oc_keisen-using-item-1)
            - [8.3.1.33. CALL “CBL_OC_NANOSLEEP” USING nanoseconds-to-sleep](#83133-call-cbl_oc_nanosleep-using-nanoseconds-to-sleep)
            - [8.3.1.34. CALL “CBL_OPEN_FILE” file-path, access-mode, 0, 0, handle](#83134-call-cbl_open_file-file-path-access-mode-0-0-handle)
            - [8.3.1.35. CALL “CBL_OR” USING item-1, item-2, BY VALUE byte-length](#83135-call-cbl_or-using-item-1-item-2-by-value-byte-length)
            - [8.3.1.36. CALL “CBL_READ_FILE” USING handle, offset, nbytes, flag, buffer](#83136-call-cbl_read_file-using-handle-offset-nbytes-flag-buffer)
            - [8.3.1.37. CALL “CBL_RENAME_FILE” USING old-file-path, new-file-path](#83137-call-cbl_rename_file-using-old-file-path-new-file-path)
            - [8.3.1.38. CALL “CBL_TOLOWER” USING data-item, BY VALUE convert-length](#83138-call-cbl_tolower-using-data-item-by-value-convert-length)
            - [8.3.1.39. CALL “CBL_TOUPPER” USING data-item, BY VALUE convert-length](#83139-call-cbl_toupper-using-data-item-by-value-convert-length)
            - [8.3.1.40. CALL “CBL_WRITE_FILE” USING handle, offset, nbytes, 0, buffer](#83140-call-cbl_write_file-using-handle-offset-nbytes-0-buffer)
            - [8.3.1.41. CALL “CBL_XOR” USING item-1, item-2, BY VALUE byte-length](#83141-call-cbl_xor-using-item-1-item-2-by-value-byte-length)
            - [8.3.1.42. CALL “SYSTEM” USING command](#83142-call-system-using-command)
9. [サンプルプログラム](#9-サンプルプログラム)
   - [9.1. FileStat-Msgs.cpy – ファイル状態コード](#91-filestat-msgscpy--ファイル状態コード)
   - [9.2. COBDUMP –16進数/文字データダンプサブルーチン](#92-cobdump--16進数文字データダンプサブルーチン)
...
<!-- markdown\1-2-1.md -->
<!--navi start1-->
[前へ](#1-まえがき)/[目次](https://opensourcecobol.github.io/markdown/TOC.html)/[次へ](#122-コピーブック)
<!--navi end1-->
...
4つの部とその機能については[2章](#2-opensource-cobolのプログラム形式)で、各部についてはそれぞれの章([3](#3-見出し部)、[4](#4-環境部)、[5](#5-データ部)、および[6章](#6-手続き部))で説明する。
...
<!-- markdown\1-2-2.md -->
<!--navi start1-->
[前へ](1-2-1.md)/[目次](https://opensourcecobol.github.io/markdown/TOC.html)/[次へ](#123-構造化データ)
<!--navi end1-->
### 1.2.2. コピーブック

「コピーブック」とは、プログラムにCOPY文([1.6](#16-copy文の使い方))を使用してそのコードをインポートするだけで、複数のプログラムで利用できるプログラムコードの部品であり、ファイル、データ構造、または手続き型コードを定義できる。
...
<!-- markdown\1-2-3.md -->
<!--navi start1-->
[前へ](#122-コピーブック)/[目次](https://opensourcecobol.github.io/markdown/TOC.html)/[次へ](#124-ファイル)
<!--navi end1-->
### 1.2.3. 構造化データ
...
<!-- markdown\1-2-4.md -->
<!--navi start1-->
[前へ](#123-構造化データ)/[目次](https://opensourcecobol.github.io/markdown/TOC.html)/[次へ](#125-表操作)
<!--navi end1-->
### 1.2.4. ファイル

COBOLの主な強みの一つは、様々なファイルにアクセスできることである。opensource COBOLは、他のCOBOL実装と同様に、読み書きするファイルの構造を記述しておく必要がある。ファイル構造の最高レベルの特性は、次のように、ファイルの編成([4.2.1](#42-入出力節))を指定することによって定義される。
...
<!-- markdown\1-2-5.md -->
<!--navi start1-->
[前へ](#124-ファイル)/[目次](https://opensourcecobol.github.io/markdown/TOC.html)/[次へ](#126-データの並び替えと結合)
<!--navi end1-->
### 1.2.5. 表操作

他のプログラミング言語にある配列と基本的に同じものとして、COBOLには表がある。COBOLの表機能を特別なものにしているのは、COBOL言語に存在する2つの文―SEARCH([6.38.1](#638-search))とSEARCH ALL([6.38.2](#6382-search文の書き方2--二分探索search-all))である。

1つ目は表を順次検索し、任意の数の検索条件のうち1つに一致する表記述項が見つかった場合、またはすべての表記述項が検索され、いずれの条件にも一致しない場合にのみ停止する。

2つ目は、それぞれの表記述項に含まれる「キー」項目で並び替えおよび検索された表に対して、<u>非常に高速に</u>検索を実行できる。このような検索に使用されるアルゴリズムは、バイナリ検索(半区間検索とも呼ばれる)と言い、目的の記述項を見つけるため、または目的の記述項が表に存在しないことを確認するために、表の少数の記述項のみを検索する必要があることが保証される。表が大きいほど、この検索方法はより効果的である。例えば、32,768の記述項がある表でも特定の記述項を見つけることができ、15記述項以下の検索で記述項が存在しないと判断することができる。このアルゴリズムは、SEARCH ALL([6.38.2](#6382-search文の書き方2--二分探索search-all))で詳しく説明している。
...
<!-- markdown\1-2-6.md -->
<!--navi start1-->
[前へ](#125-表操作)/[目次](https://opensourcecobol.github.io/markdown/TOC.html)/[次へ](#127-文字列操作)
<!--navi end1-->
### 1.2.6. データの並び替えと結合

COBOL言語には、任意の複雑なキー構造に従って大量のデータを並び替えることができる強力なSORT文([6.40.1](#640-sort))がある。このデータは、プログラム内で生成される場合もあれば、1つ以上の外部ファイルのものを扱う場合もある。並び替えられたデータは、1つ以上の出力ファイルに自動的に書き込まれるか、並び替えられた順番でレコードごとに処理される。

表のデータを並び替えるためだけの特別な形式のSORT文([6.40.2](#6402-sort文の書き方2--テーブルソート))も存在し、表に対してSEARCH ALLを使用する場合に特に便利である。

同類の文―MERGE([6.27](#627-merge))―では、複数のファイルの内容を結合できるが、ファイルはすべて同じキー構造に従って同様の方法で並べ替えられる。出力結果は、入力ファイルの内容で構成されており、結合されると共通のキー構造に従って順序付けられ、1つ以上の出力ファイルに自動的に書き込まれるか、プログラムによって内部的に処理される。

<!--navi start2-->

[ページトップへ](#126-データの並び替えと結合)
<!--navi end2-->
<div class="page-break"></div>

<!-- markdown\1-2-7.md -->
<!--navi start1-->
[前へ](#126-データの並び替えと結合)/[目次](https://opensourcecobol.github.io/markdown/TOC.html)/[次へ](#128-テキストユーザインターフェースtui機能)
<!--navi end1-->
### 1.2.7. 文字列操作
...
| :--- | :--- |
|2 つ以上の文字列を連結する  |  CONCATENATE組み込み関数 <!--(6.1.7.9)--><br>STRING文([6.43](#643-string)) |
...
| 文字列を小文字に変換する | LOWER-CASE組み込み関数<!--(6.1.7.35)--><br>C$TOLOWER組み込みサブルーチン([8.3.1.12](#83112-call-ctolower-using-data-item-by-value-convert-length))<br>CBL_TOLOWER組み込みサブルーチン([8.3.1.38](#83138-call-cbl_tolower-using-data-item-by-value-convert-length)) |
| 文字列を大文字に変換する | UPPER-CASE組み込み関数<!--(6.1.7.67)--><br>C$TOUPPER組み込みサブルーチン([8.3.1.13](#83113-call-ctoupper-using-data-item-by-value-convert-length))<br>CBL_TOUPPER組み込みサブルーチン([8.3.1.39](#83139-call-cbl_toupper-using-data-item-by-value-convert-length)) |
| 文字をプログラムの文字セットに対応する数値に変換する | ORD組み込み関数<!--(6.1.7)--><br>結果から1を引く。ORD関数の説明では、数値型引数の値に1を追加しなくても同じ結果が得られるMOVE文の利用法を示している |
| 文字列内にある部分文字列の出現回数をカウントする | TALLYINGオプションを指定したINSPECT文([6.26](#626-inspect)) |
...
| 文字列の開始位置と長さに基づいて部分文字列を抽出する | 「送信」項目に部分参照を含むMOVE文([6.28.1](#628-move)) |
| 桁区切り記号 (日本では「,」)、通貨記号(日本では「¥」)、小数点、クレジット/デビット記号、先頭または末尾の記号文字を含む、出力用の数値項目を書式化する | 受け取り項目に適用されたPICTURE編集記号([5.3](#53-データ記述の形式))を指定したMOVE文([6.28](#628-move))|
| 文字列項目の位置揃え(左、右、または中央) | C$JUSTIFY組み込みサブルーチン([8.3.1.6](#8316-call-cjustify-using-data-item-justification-type)) |
| 文字列内の1つ以上の文字を異なる文字で単アルファベット置換する | CONVERTINGオプションを指定したINSPECT文([6.26](#626-inspect))<br>TRANSFORM文([6.47](#647-transform))<br>SUBSTITUTE組み込み関数<!--(6.1.7.60)--><br>および<br>SUBSTITUTE-CASE組み込み関数<!--(6.1.7.61)--> |
| 文字列を解析し、1つ以上の区切り文字順序に基づいて部分文字列に分割する<br>これらの区切り文字は、単一の文字、複数の文字列、またはいずれかが重複した連続オカレンスの可能性がある | UNSTRING文([6.49](#649-unstring)) |
| 文字列の先頭または末尾の空白の削除 | TRIM組み込み関数<!--(6.1.7.66)--> |
| 部分文字列の開始文字位置と長さに基づいて、単一の部分文字列を<u>同じ長さの</u>別の部分文字列に置換する | 「受け取り」項目に部分参照を含むMOVE文([6.28.1](#628-move)) |
| 文字列内にある1つ以上の部分文字列を、オカレンス位置に関係なく、<u>同じ長さの</u>置換部分文字列に置換する | REPLACINGオプションを指定したINSPECT文([6.26](#626-inspect))<br>SUBSTITUTE組み込み関数<!--(6.1.7.60)--><br>および<br>SUBSTITUTE-CASE組み込み関数<!--(6.1.7.61)--> |
...
<!-- markdown\1-2-8.md -->
<!--navi start1-->
[前へ](#127-文字列操作)/[目次](https://opensourcecobol.github.io/markdown/TOC.html)/[次へ](#13-構文規則)
<!--navi end1-->
...
このような画面`2`は、データ部([5.6](#56-画面記述))の画面節で定義され、一度定義されると、画面はACCEPT文([6.4.4](#644-accept文の書き方4--画面データの取得))およびDISPLAY文([6.14.4](#6144-display文の書き方4--画面データ))を介して実行時に再度使用される。
...
[ページトップへ](#128-テキストユーザインターフェースtui機能)
<!--navi end2-->
<div class="page-break"></div>

<!-- markdown\1-3.md -->
<!--navi start1-->
[前へ](#128-テキストユーザインターフェースtui機能)/[目次](https://opensourcecobol.github.io/markdown/TOC.html)/[次へ](#14-ソースコードの形式)
<!--navi end1-->
## 1.3. 構文規則
...
<!-- markdown\1-4.md -->
<!--navi start1-->
[前へ](#13-構文規則)/[目次](https://opensourcecobol.github.io/markdown/TOC.html)/[次へ](#15-カンマセミコロンの使い方)
<!--navi end1-->
## 1.4. ソースコードの形式
...
[ページトップへ](#14-ソースコードの形式)
<!--navi end2-->
<div class="page-break"></div>

<!-- markdown\1-5.md -->
<!--navi start1-->
[前へ](#14-ソースコードの形式)/[目次](https://opensourcecobol.github.io/markdown/TOC.html)/[次へ](#16-copy文の使い方)
<!--navi end1-->
## 1.5. カンマ/セミコロンの使い方

空白が有効な場所(もちろん英数字定数内を除く)での読みやすさ向上のために、コンマ文字(,)またはセミコロン(;)をopensource COBOLプログラムにオプションとして挿入できる。COBOL標準ではコンマを使用する場合、コンマの後に少なくとも一つの空白を続ける必要がある。最近、COBOLコンパイラー(opensource COBOLを含む)の多くは、この規則を緩和して、ほとんどの場合で空白を省略できるようになったが、これにより、DECIMAL POINT IS COMMA句が使用されている場合([4.1.4](#414-特殊名段落)を参照)、コンパイラに「混乱」が生じる可能性がある。
...
[ページトップへ](#15-カンマセミコロンの使い方)
<!--navi end2-->
<div class="page-break"></div>

<!-- markdown\1-6.md -->
<!--navi start1-->
[前へ](#15-カンマセミコロンの使い方)/[目次](https://opensourcecobol.github.io/markdown/TOC.html)/[次へ](#17-定数の使い方)
<!--navi end1-->
## 1.6. COPY文の使い方
...
COPY文は、プログラムにコピーブック([1.2.2](#122-コピーブック))をインポートするために使われる。
...
11. プログラムのコンパイル時にopensource COBOLコンパイラがコピーブックを見つける方法の詳細については、「[8.1.8](#818-コンパイル時のコピーブックの検索) コンパイル時のコピーブックの検索」で説明する。

<!--navi start2-->

[ページトップへ](#16-copy文の使い方)
<!--navi end2-->
<div class="page-break"></div>

<!-- markdown\1-7-1.md -->
<!--navi start1-->
[前へ](#16-copy文の使い方)/[目次](https://opensourcecobol.github.io/markdown/TOC.html)/[次へ](#172-英数字定数)
<!--navi end1-->
## 1.7. 定数の使い方
...
<!-- markdown\1-7-2.md -->
<!--navi start1-->
[前へ](#17-定数の使い方)/[目次](https://opensourcecobol.github.io/markdown/TOC.html)/[次へ](#173-日本語定数)
<!--navi end1-->
### 1.7.2. 英数字定数

英数字定数は、コンピュータ画面での表示、レポートへの印刷、通信接続を介した伝送、またはPIC XまたはPIC Aデータ項目への格納に適した文字列である([5.3](#53-データ記述の形式))。これらは、同等の数値計算に変換できない限り、算術式で使用することはできない<!--(6.1.7のNUMVALおよびNUMVAL-C組み込み関数を参照)-->。
...
- ソースコード形式の固定モード([1.4](#14-ソースコードの形式))を使用している場合、英数字定数は72桁目まで実行できる。定数は、一重引用符または二重引用符(最初の行の定数を開始するときに使用した方)をコーディングすることにより、次の行の11桁目以降に続けることができる。次の行では7桁目にハイフン(–)をコーディングする必要がある。以下がその例である。
...
<!-- markdown\1-7-3.md -->
<!--navi start1-->
[前へ](#172-英数字定数)/[目次](https://opensourcecobol.github.io/markdown/TOC.html)/[次へ](#18-表意定数の使い方)
<!--navi end1-->
### 1.7.3. 日本語定数
...
<!-- markdown\1-8.md -->
<!--navi start1-->
[前へ](#173-日本語定数)/[目次](https://opensourcecobol.github.io/markdown/TOC.html)/[次へ](#19-ユーザ定義名)
<!--navi end1-->
## 1.8. 表意定数の使い方

表意定数は、特定の定数の代用となる予約語である。一般に、表意定数は対応する値が使用可能な場所であればどこでも自由に使用することができ、値の前に「ALL」が付いているかのように解釈される(「ALL」については[5.3](#53-データ記述の形式)で説明する)。
...
<!-- markdown\1-9.md -->
<!--navi start1-->
[前へ](#18-表意定数の使い方)/[目次](https://opensourcecobol.github.io/markdown/TOC.html)/[次へ](#110-length-ofの使い方)
<!--navi end1-->
## 1.9. ユーザ定義名
...
<!-- markdown\1-10.md -->
<!--navi start1-->
[前へ](#19-ユーザ定義名)/[目次](https://opensourcecobol.github.io/markdown/TOC.html)/[次へ](#2-opensource-cobolのプログラム形式)
<!--navi end1-->
## 1.10. LENGTH OFの使い方
...
[ページトップへ](#110-length-ofの使い方)
<!--navi end2-->
<div class="page-break"></div>

<!-- markdown\2-1.md -->
<!--navi start1-->
[前へ](#110-length-ofの使い方)/[目次](https://opensourcecobol.github.io/markdown/TOC.html)/[次へ](#22-ネストされたユーザ定義関数)
<!--navi end1-->
...
| 区分 | 目的 |
| :--- | :--- |
| 見出し | プログラムID(プログラム名)を指定することにより、プログラムの基本認証を定義する([3章](#3-見出し部))。 |
| 環境 | プログラムが動作する外部計算機環境を定義する区域で、プログラムがアクセスする可能性のあるファイルの定義を含む([4章](#4-環境部))。 |
| データ | プログラムが処理するすべてのデータを定義する([5章](#5-データ部))。 |
| 手続き | すべての実行可能プログラムコードを含む([6章](#6-手続き部))。 |
...
[ページトップへ](#2-opensource-cobolのプログラム形式)
<!--navi end2-->
<div class="page-break"></div>

<!-- markdown\2-2.md -->
<!--navi start1-->
[前へ](#2-opensource-cobolのプログラム形式)/[目次](https://opensourcecobol.github.io/markdown/TOC.html)/[次へ](#3-見出し部)
<!--navi end1-->
## 2.2. ネストされたユーザ定義関数
...
[ページトップへ](#22-ネストされたユーザ定義関数)
<!--navi end2-->
<div class="page-break"></div>

<!-- markdown\3.md -->
<!--navi start1-->
[前へ](#22-ネストされたユーザ定義関数)/[目次](https://opensourcecobol.github.io/markdown/TOC.html)/[次へ](#4-環境部)
<!--navi end1-->
# 3. 見出し部
...
<!-- markdown\4-1-1.md -->
<!--navi start1-->
[前へ](#3-見出し部)/[目次](https://opensourcecobol.github.io/markdown/TOC.html)/[次へ](#412-実行用計算機段落)
<!--navi end1-->
# 4. 環境部
...
3. ただし、opensource COBOLコンパイラへの「**-fdebugging-line**」スイッチを指定することで、プログラムのデバッグ行をコンパイルできる。opensource COBOLプログラムでデバッグ行を指定する方法については[1.4](#14-ソースコードの形式)で説明している。
...
<!-- markdown\4-1-2.md -->
<!--navi start1-->
[前へ](#4-環境部)/[目次](https://opensourcecobol.github.io/markdown/TOC.html)/[次へ](#413-リポジトリ段落)
<!--navi end1-->
### 4.1.2. 実行用計算機段落
...
3. PROGRAM COLLATING SEQUENCE句を使用すると、英数字の値を相互に比較するときに用いる、カスタマイズされた文字の大小順序を指定できる。データは引き続き計算機に固有の文字セットに格納されるが、比較のために文字が並べ替えられる論理的な順序を計算機に固有の文字セットに変更できる。符号系名-1は、特殊名節([4.1.4](#414-特殊名段落))で定義する必要がある。

4. PROGRAM COLLATING SEQUENCE句が指定されていない場合、計算機に固有の文字セット(通常はASCII)によって暗示される大小順序が使用される。

<!--navi start2-->

[ページトップへ](#412-実行用計算機段落)
<!--navi end2-->
<div class="page-break"></div>

<!-- markdown\4-1-3.md -->
<!--navi start1-->
[前へ](#412-実行用計算機段落)/[目次](https://opensourcecobol.github.io/markdown/TOC.html)/[次へ](#414-特殊名段落)
<!--navi end1-->
### 4.1.3. リポジトリ段落
...
<!-- markdown\4-1-4.md -->
<!--navi start1-->
[前へ](#413-リポジトリ段落)/[目次](https://opensourcecobol.github.io/markdown/TOC.html)/[次へ](#42-入出力節)
<!--navi end1-->
### 4.1.4. 特殊名段落
...
1. CONSOLE IS CRT句は、opensource COBOLの他のバージョンとのソースコードの互換性を保持する。これにより、デバイス「CRT」と「CONSOLE」をDISPLAY文([6.14.1](#614-display))およびACCEPT文([6.4.1](#64-accept))で相互に使用できるようになる。opensource COBOLプログラムを「ゼロから」コーディングする場合は、これら二つのデバイスはすでに同様のものと見なされているため、この句は必要ない。
...
7. CURRENCY SIGN句を使って、PICTURE編集記号で使用される通貨記号として任意の1文字を定義できる([表5-9](#53-データ記述の形式)を参照)。通貨記号が指定されていない場合の既定値は円記号(¥)である。

8. DECIMAL POINT IS COMMA句は、PICTURE編集記号([表5-9](#53-データ記述の形式)を参照)および数字定数として使用される場合「,」および「.」文字の定義を逆にするが、望ましくない副作用が生じる可能性がある([1.5](#15-カンマセミコロンの使い方)を参照)。
...
<!-- markdown\4-2-1-1.md -->
<!--navi start1-->
[前へ](#414-特殊名段落)/[目次](https://opensourcecobol.github.io/markdown/TOC.html)/[次へ](#4212-相対編成ファイル)
<!--navi end1-->
## 4.2. 入出力節
...
1. 使用しているコンパイラの「config」ファイルの「relaxed-syntax-check」が「yes」に設定されている場合、入出力節のヘッダーを指定せずにファイル管理および入出力管理段落を指定することができる。構成ファイルやプログラムへの影響については[8.1.8](#818-コンパイル時のコピーブックの検索)で説明する。
...
2. OPTIONAL句は、プログラムに入力データを渡すために用いられるファイルにのみ使用され、ファイルの実行時に使用可能であるかどうかを示す。ファイルが存在しないときにOPTIONALファイルを開こうとすると([6.31](#631-open))、ファイルが使用できないことを示す、致命的ではないが特別なファイルステータス値(表4-11のステータスコード05を参照)を受け取る。その後にファイルを読み取ろうとすると([6.33](#633-read))、ファイル終了条件が返される。
...
4. ASSIGN句で「定数-1」オプションを使用すると、COBOLファイルからオペレーティングシステムファイルへの外部リンクが次のように定義される。
    ...
    この動作は、プログラムのコンパイル時に用いる構成ファイルの「filename-mapping」設定の影響を受ける。上記の動作は、「filename-mapping：yes」が有効な場合にのみ適用され、「filename-mapping：no」に設定すると、最後のオプション(定数自体をフルファイル名として扱う)のみが可能となる。構成ファイルやプログラムへの影響については[8.1.8](#818-コンパイル時のコピーブックの検索)で説明する。
...
5. LOCK句とSHARING句は、このファイルと同時に実行されている他のプログラムも、ファイルを使用できる条件を定義する。ファイルのロックと共有については、[6.1.8](#618-ファイルへの同時アクセス制御)で説明する。
...
8. SEQUENTIALファイルの処理に関する文については、CLOSE([6.9](#69-close))、COMMIT([6.10](#610-commit))、DELETE([6.13](6-13.md))、MERGE([6.27](#627-merge))、OPEN([6.31](#631-open))、READ([6.33](#633-read))、REWRITE([6.36](#636-rewrite))、SORT([6.40.1](#640-sort))、UNLOCK([6.48](#648-unlock))およびWRITE([6.50](#650-write))で説明する。
...
<!-- markdown\4-2-1-2.md -->
<!--navi start1-->
[前へ](#42-入出力節)/[目次](https://opensourcecobol.github.io/markdown/TOC.html)/[次へ](#4213-索引編成ファイル)
<!--navi end1-->
#### 4.2.1.2. 相対編成ファイル
...
4. SEQUENTIALのACCESS MODEではファイルのレコードが順次処理され、RANDOMのACCESS MODEではレコードがランダムに処理される。DYNAMIC ACCESS MODEでは、ファイルがRANDOMまたはSEQUENTIALモードのいずれかで処理され、プログラムの実行時に二つのどちらかを切り替えることができる([6.41](#641-start)のSTART文を参照)。
...
7. RELATIVEファイルの処理に関する文については、CLOSE([6.9](#69-close))、COMMIT([6.10](#610-commit))、DELETE([6.13](6-13.md))、MERGE([6.27](#627-merge))、OPEN([6.31](#631-open))、READ([6.33](#633-read))、REWRITE([6.36](#636-rewrite))、SORT([6.40.1](#640-sort))、START([6.41](#641-start))、UNLOCK([6.48](#648-unlock))およびWRITE([6.50](#650-write))で説明する。

<!--navi start2-->

[ページトップへ](#4212-相対編成ファイル)
<!--navi end2-->
<div class="page-break"></div>

<!-- markdown\4-2-1-3.md -->
<!--navi start1-->
[前へ](#4212-相対編成ファイル)/[目次](https://opensourcecobol.github.io/markdown/TOC.html)/[次へ](#422-入出力管理段落)
<!--navi end1-->
#### 4.2.1.3. 索引編成ファイル
...
1. SEQUENTIALのACCESS MODEでは、ファイルのレコードがRECORD KEYまたはALTERNATE RECORD KEYの値によって順次処理され、RANDOMのACCESS MODEではレコードがキー項目内でランダムに処理される。DYNAMIC ACCESS MODEでは、ファイルがRANDOMまたはSEQUENTIALモードのいずれかで処理され、プログラムの実行時に二つのどちらかを切り替えることができる([6.41](#641-start)のSTART文を参照)。
...
7. INDEXEDファイルの処理に関する文については、CLOSE([6.9](#69-close))、COMMIT([6.10](#610-commit))、DELETE([6.13](6-13.md))、MERGE([6.27](#627-merge))、OPEN([6.31](#631-open))、READ([6.33](#633-read))、REWRITE([6.36](#636-rewrite))、SORT([6.40.1](#640-sort))、START ([6.41](#641-start))、UNLOCK([6.48](#648-unlock))およびWRITE([6.50](#650-write))で説明する。

<!--navi start2-->

[ページトップへ](#4213-索引編成ファイル)
<!--navi end2-->
<div class="page-break"></div>

<!-- markdown\4-2-2.md -->
<!--navi start1-->
[前へ](#4213-索引編成ファイル)/[目次](https://opensourcecobol.github.io/markdown/TOC.html)/[次へ](#5-データ部)
<!--navi end1-->
### 4.2.2. 入出力管理段落
...
<!-- markdown\5-1.md -->
<!--navi start1-->
[前へ](#422-入出力管理段落)/[目次](https://opensourcecobol.github.io/markdown/TOC.html)/[次へ](#52-整列用記述)
<!--navi end1-->
# 5. データ部
...
7. LINAGE句は図5-3からわかるように、印刷ページの様々な領域の論理的な境界線を(行数の観点から)指定するために使用される。このページ構造の利用方法については、[6.50](#650-write)(WRITE文)で説明する。
...
<!-- markdown\5-2.md -->
<!--navi start1-->
[前へ](#5-データ部)/[目次](https://opensourcecobol.github.io/markdown/TOC.html)/[次へ](#53-データ記述の形式)
<!--navi end1-->
## 5.2. 整列用記述
...
整列用ファイル([6.27](#627-merge)および[6.40.1](#640-sort)を参照)はファイル記述ではなく、整列用記述を使って説明する。
...
4. 一方でデータ量の確保にディスク作業ファイルが必要な場合、TMPDIR、TMP、またはTEMP環境変数で定義されたフォルダ内のディスクに自動で割り当てられる([8.2.4](#824-重要な環境変数)を参照)。これらのディスクファイルは、プログラムの実行が(通常またはその他の方法で)終了した場合、自動で削除されない。一時的な整列用作業ファイルは、自分自身から、または整列が終了した自分のプログラムから、ファイルを削除したい場合に「cob*.tmp」と命名される。
...
<!-- markdown\5-3.md -->
<!--navi start1-->
[前へ](#52-整列用記述)/[目次](https://opensourcecobol.github.io/markdown/TOC.html)/[次へ](#54-条件名)
<!--navi end1-->
## 5.3. データ記述の形式
...
2. 他のCOBOL実装と同様に、レベル番号は以下の値に制限されている。
    ...
    この他にも特別な使い方をする二つのレベル番号(78と88)があるが、それは[5.5](#55-定数記述)(78)と[5.4](#54-条件名)(88)でそれぞれ解説する。
...
7. 編集記号を含む数値データ項目は、数値編集項目と呼ばれる。このようなデータ項目は、様々な算術文で値を受け取る場合があるが、同じ文でデータのソースとして使用することはできない。これに該当するのは、ADD文([6.5](#65-add))、COMPUTE文([6.11](#611-compute))、DIVIDE文([6.15](#615-divide))、MULTIPLY文([6.29](#629-multiply))、およびSUBTRACT文([6.44](#644-subtract))である。
...
9. GLOBAL句を指定することにより、データ項目は、各プログラム単位でGLOBAL句を使って記述されている場合、<u>そして</u>GLOBAL句を使用したすべてのプログラム単位が、GLOBAL句を使用したデータ項目を定義する最初のプログラム単位内に<u>ネスト</u>されている場合、特定の実行スレッド内の同じコンパイル単位内のすべてのプログラム単位間で共有できる。プログラム単位のネストについては、[2.1](#21-ネストされたユーザプログラム)で説明している。
...
14. OCCURS句は、複数回繰り返される表`9`と呼ばれるデータ構造を作成するため、次の例のように使用される。
    ...
    表の詳細については、[6.1.1](#6-手続き部)(表の参照)、[6.38](#638-search)(SEARCH)、[6.40](#640-sort)(SORT)、および以下の28項で説明する。
...
18. ASCENDING KEY句、DESCENDING KEY句、およびINDEXED BY句については、[6.38](#638-search)(SEARCH)で説明する。
...
25. 次の表は、利用可能なUSAGE句をまとめたものである。
    ...
    | USAGE句 | 割り当て領域(バイト)  |ストレージ形式|負の値|PIC|類似USAGE句|
      | :--- | :--- |:--- | :--- |:--- | :--- |
      | <u>BINARY</u> | PICTURE句の「9」の数と、プログラムのコンパイルに使用される構成ファイル([8.1.8](#818-コンパイル時のコピーブックの検索))の「バイナリサイズ」設定によって異なる。 | 最互換性―24項参照 |PICTURE句に「S」記号がある場合は可 | 可 | COMPUTATIONAL, COMPUTATIONAL-4 |
      ...
      | <u>COMP</u>UTATIONAL | PICTURE句の「9」の数と、プログラムのコンパイルに使用される構成ファイル([8.1.8](#818-コンパイル時のコピーブックの検索))の「バイナリサイズ」設定によって異なる。 | 最互換性 ― 24項参照 | PICTURE句に「S」記号がある場合は可 | 可 | BINARY, COMPUTATIONAL-4 |
      ...
      | <u>COMP</u>UTATIONAL<u>-4</u> | PICTURE句の「9」の数と、プログラムのコンパイルに使用される構成ファイル([8.1.8](#818-コンパイル時のコピーブックの検索))の「バイナリサイズ」設定によって異なる。 | 最互換性 ― 24項参照 | PICTURE句に「S」記号がある場合は可 | 可 | BINARY, COMPUTATIONAL |
      | <u>COMP</u>UTATIONAL<u>-5</u>|PICTURE句の「9」の数と、プログラムのコンパイルに使用される構成ファイル([8.1.8](#818-コンパイル時のコピーブックの検索))の「バイナリサイズ」設定によって異なる。 | | PICTURE句に「S」記号がある場合は可 | 可 | |
      | <u>COMP</u>UTATIONAL<u>-X</u> | プログラムのコンパイルに使用される構成ファイル内の「1～8」の「バイナリサイズ」設定に従って、PICTURE句の「9」の数に基づいてバイトを割り当てる。「バイナリサイズ」の値「1～8」がどのように機能するかについては、[8.1.8](#818-コンパイル時のコピーブックの検索)を参照すること。 | 最互換性 ― 24項参照 | PICTURE句に「S」記号がある場合は可 | 可 | |
...
---
`7` デフォルトの通貨記号は「$」であるが、他の国では異なる通貨記号を使用している。特殊名段落([4.1.4](#414-特殊名段落)を参照)では、任意の記号を通貨記号として定義することができる。例えば、通貨記号が「#」という文字に定義されている場合、「#」文字をPICTURE編集記号として使用できる。
...
<!-- markdown\5-4.md -->
<!--navi start1-->
[前へ](#53-データ記述の形式)/[目次](https://opensourcecobol.github.io/markdown/TOC.html)/[次へ](#55-定数記述)
<!--navi end1-->
## 5.4. 条件名
...
4. オプションのFALSE句は、SET文を使用して条件名-1をFALSEに設定した場合に、親の基本データ項目に割り当てられる明示的な値を定義する。SET文を使用して、条件名のTRUE/FALSE値を指定する方法については、[6.39.6](#6396-set文の書き方6--条件名設定)で詳しく説明する。
...
<!-- markdown\5-5.md -->
<!--navi start1-->
[前へ](#54-条件名)/[目次](https://opensourcecobol.github.io/markdown/TOC.html)/[次へ](#56-画面記述)
<!--navi end1-->
## 5.5. 定数記述
...
<!-- markdown\5-6.md -->
<!--navi start1-->
[前へ](#55-定数記述)/[目次](https://opensourcecobol.github.io/markdown/TOC.html)/[次へ](#6-手続き部)
<!--navi end1-->
## 5.6. 画面記述
...
上に示した構文の枠組みは、画面節でデータ項目がどのように定義されているかを表す。これらのデータ項目は、特別な形式のACCEPT文([6.4](#64-accept))およびDISPLAY文([6.14.4](#6144-display文の書き方4--画面データ))を介して使用され、TUI(「テキストユーザインターフェース」プログラム)を作成する。
...
<!-- markdown\6-1-1.md -->
<!--navi start1-->
[前へ](#56-画面記述)/[目次](https://opensourcecobol.github.io/markdown/TOC.html)/[次へ](#612-データ名の修飾)
<!--navi end1-->
# 6. 手続き部
...
算術式については[6.1.4.1](#6141-算術式)で説明する。
...
<!-- markdown\6-1-2.md -->
<!--navi start1-->
[前へ](#6-手続き部)/[目次](https://opensourcecobol.github.io/markdown/TOC.html)/[次へ](#613-部分参照)
<!--navi end1-->
### 6.1.2. データ名の修飾
...
<!-- markdown\6-1-3.md -->
<!--navi start1-->
[前へ](#612-データ名の修飾)/[目次](https://opensourcecobol.github.io/markdown/TOC.html)/[次へ](#614-式)
<!--navi end1-->
### 6.1.3. 部分参照
...
<!-- markdown\6-1-4-1.md -->
<!--navi start1-->
[前へ](#613-部分参照)/[目次](https://opensourcecobol.github.io/markdown/TOC.html)/[次へ](#6142-条件式)
<!--navi end1-->
### 6.1.4. 式
...
<!-- markdown\6-1-4-2.md -->
<!--navi start1-->
[前へ](#614-式)/[目次](https://opensourcecobol.github.io/markdown/TOC.html)/[次へ](#615-ピリオド)
<!--navi end1-->
#### 6.1.4.2. 条件式
...
6. OMITTED字類条件は、サブルーチンが、特定の引数が引き渡されたか判別する必要がある場合に使用される。このような字類条件における一意名-1は、サブプログラムの「手続き部」ヘッダーのUSING句で定義された、連絡節の項目である必要がある。CALLからサブプログラムへの引数を省略する方法については、[6.7](#67-call)で説明する。
...
特殊名段落([4.1.4](#414-特殊名段落)を参照)では、外部スイッチ名を1つ以上の条件名と関連付けることができる。これらの条件名を使って、外部スイッチがオンまたはオフの状態にあるか判別できる。
...
2. 文字列を比較する場合、比較はプログラムの大小順序を基に行われる([4.1.2](#412-実行用計算機段落)を参照)。二つの文字列引数の長さが等しくないとき、短い方の文字列には、長い方と同じ長さになる数の空白が(右側に)埋め込まれていると見なされる。文字列の比較は、異なる文字のペアが見つかるまで、対応する文字ごとに実行される。その時点で、ペアとなった文字のそれぞれが大小順序のどこに位置するかによって、どちらがもう一方の文字よりも大きいか(または小さいか)が決まる。
...
<!-- markdown\6-1-5.md -->
<!--navi start1-->
[前へ](#6142-条件式)/[目次](https://opensourcecobol.github.io/markdown/TOC.html)/[次へ](#616-動詞end-動詞)
<!--navi end1-->
### 6.1.5. ピリオド(.)
...
<!-- markdown\6-1-6.md -->
<!--navi start1-->
[前へ](#615-ピリオド)/[目次](https://opensourcecobol.github.io/markdown/TOC.html)/[次へ](#617-特殊レジスタ)
<!--navi end1-->
### 6.1.6. 動詞/END-動詞
...
NEXT SENTENCE文([6.30](#630-next-sentence)参照)は、「B = 1」条件が偽の場合、次に来るピリオドの後に続く最初の文に進むようCOBOLに通知する。
...
`13` 例えばSTRING([6.43](#643-string))とUNSTRING([6.49](#649-unstring))には、範囲符が必要なステートメントにオプションを導入するといった将来的な標準に向けての計画はあるのだろうか？

<!--navi start2-->

[ページトップへ](#616-動詞end-動詞)
<!--navi end2-->
<div class="page-break"></div>

<!-- markdown\6-1-7.md -->
<!--navi start1-->
[前へ](#616-動詞end-動詞)/[目次](https://opensourcecobol.github.io/markdown/TOC.html)/[次へ](#618-ファイルへの同時アクセス制御)
<!--navi end1-->
### 6.1.7. 特殊レジスタ
...
| :--- | :--- |:--- |
| LINAGE-COUNTER | BINARY-LONG SIGNED | このレジスタのオカレンスは、LINAGE句を持つSELECTで指定された各ファイルに存在する([5.1](#51-ファイル記述)を参照)。FDにLINAGE句があるファイルが複数ある場合、このレジスタへの明示的な参照には修飾が必要である(「OFファイル名」を使用)。<br>このレジスタの値は、ページ本体内の現在の論理行番号になる(LINAGE句が論理ページを構成する方法については[5.1](#51-ファイル記述)を参照)。<br>***このレジスタの内容は変更してはいけない。*** |
| NUMBER-OF-CALL-PARAMETERS | BINARY-LONG SIGNED | このレジスタには、サブプログラムに渡される引数の数が含まれている。メインプログラムで参照されると、その値はゼロになる。<br>同じデータを取得する別の方法については、[8.3.1.9](#8319-call-cnarg-using-arg-count-result)のC$NARG組み込みサブルーチンのドキュメントを参照。 |
| RETURN-CODE | BINARY-LONG SIGNED | このレジスタは、数値データ項目を提供する。サブルーチンは、それCALLしたプログラムに制御を戻す前に値をMOVEしたり、メインプログラムがオペレーティングシステムに制御を返す前に値をMOVEしたりすることができる。<br>ほとんどの組み込みサブルーチン([8.3](#83-組み込みサブルーチン))が、このレジスタを使用して値を返す。<br>これらの値は―規則により―RETURN-CODE値を設定したプログラムが実行しようとしていたプロセスの成功(通常は値0)または失敗(通常は0以外の値)を示すために使用される。 |
...
---
`14` PICTURE句またはUSAGE句の仕様の説明については[5.3](#53-データ記述の形式)を参照。
...
<!-- markdown\6-1-8-1.md -->
<!--navi start1-->
[前へ](#617-特殊レジスタ)/[目次](https://opensourcecobol.github.io/markdown/TOC.html)/[次へ](#6182-レコードロック)
<!--navi end1-->
...
| NO OTHER| あなたのプログラムがファイルを使用している限り、他の<u>どんな</u>プログラムによる、<u>どんな</u>ファイルアクセスも許可しない。他のプログラムによって行われたOPENの試行は、あなたがファイルを閉じるまでファイル状態コード37(「ファイルアクセスが拒否されました」)で失敗する([6.9](#69-close)を参照)。 |
...
[ページトップへ](#618-ファイルへの同時アクセス制御)
<!--navi end2-->
<div class="page-break"></div>

<!-- markdown\6-1-8-2.md -->
<!--navi start1-->
[前へ](#618-ファイルへの同時アクセス制御)/[目次](https://opensourcecobol.github.io/markdown/TOC.html)/[次へ](#62-記述形式)
<!--navi end1-->
#### 6.1.8.2. レコードロック
...
ロックを保持しているプログラムが終了するか、ファイルに対してCLOSE文([6.9](#69-close))、UNLOCK文([6.48](#648-unlock))、COMMIT文([6.10](#610-commit))、またはROLLBACK文([6.37](#637-rollback))を実行するまでロックが有効である。
...
使用しているopensource COBOLビルドがBDBを利用するように構成されている場合、実行時環境変数DB_HOMEを使って([8.2.4](#824-重要な環境変数)を参照)レコードロックを使用できる。

<!--navi start2-->

[ページトップへ](#6182-レコードロック)
<!--navi end2-->
<div class="page-break"></div>

<!-- markdown\6-2.md -->
<!--navi start1-->
[前へ](#6182-レコードロック)/[目次](https://opensourcecobol.github.io/markdown/TOC.html)/[次へ](#63-宣言の記述形式)
<!--navi end1-->
## 6.2. 記述形式
...
手続き部の最初の(オプション)セグメントは、「宣言」と呼ばれる特別な領域となっている。この領域内では、特定のイベントが発生した場合のみ実行される特殊な「トラップ」としての処理ルーチンを定義できる。これについては次の[6.3](#63-宣言の記述形式)で説明する。
...
<!-- markdown\6-3.md -->
<!--navi start1-->
[前へ](#62-記述形式)/[目次](https://opensourcecobol.github.io/markdown/TOC.html)/[次へ](#64-accept)
<!--navi end1-->
## 6.3. 宣言の記述形式
...
<!-- markdown\6-4-1.md -->
<!--navi start1-->
[前へ](#63-宣言の記述形式)/[目次](https://opensourcecobol.github.io/markdown/TOC.html)/[次へ](#642-accept文の書き方2--コマンドライン引数の取得)
<!--navi end1-->
## 6.4. ACCEPT
...
<!-- markdown\6-4-2.md -->
<!--navi start1-->
[前へ](#64-accept)/[目次](https://opensourcecobol.github.io/markdown/TOC.html)/[次へ](#643-accept文の書き方3--環境変数値の取得)
<!--navi end1-->
...
4. オプションの例外処理の構文と使用法については、[6.4.7](#647-accept文の例外処理)で説明する。
...
[ページトップへ](#642-accept文の書き方2--コマンドライン引数の取得)
<!--navi end2-->
<div class="page-break"></div>

<!-- markdown\6-4-3.md -->
<!--navi start1-->
[前へ](#642-accept文の書き方2--コマンドライン引数の取得)/[目次](https://opensourcecobol.github.io/markdown/TOC.html)/[次へ](#644-accept文の書き方4--画面データの取得)
<!--navi end1-->
...
3. オプションの例外処理の構文と使用法については、[6.4.7](#647-accept文の例外処理)で説明する。
...
[ページトップへ](#643-accept文の書き方3--環境変数値の取得)
<!--navi end2-->
<div class="page-break"></div>

<!-- markdown\6-4-4.md -->
<!--navi start1-->
[前へ](#643-accept文の書き方3--環境変数値の取得)/[目次](https://opensourcecobol.github.io/markdown/TOC.html)/[次へ](#645-accept文の書き方5--日付時刻の取得)
<!--navi end1-->
...
3. UPDATEとSCROLLを除いて、ほとんどのWITHオプションについて[5.6](#56-画面記述)で説明している。SCROLL以外のWITHオプションは、1回だけ指定する必要がある。
...
6. オプションの例外処理の構文と使用法については、[6.4.7](#647-accept文の例外処理)で説明する。

<!--navi start2-->

[ページトップへ](#644-accept文の書き方4--画面データの取得)
<!--navi end2-->
<div class="page-break"></div>

<!-- markdown\6-4-5.md -->
<!--navi start1-->
[前へ](#644-accept文の書き方4--画面データの取得)/[目次](https://opensourcecobol.github.io/markdown/TOC.html)/[次へ](#646-accept文の書き方6--画面サイズデータの取得)
<!--navi end1-->
...
[ページトップへ](#645-accept文の書き方5--日付時刻の取得)
<!--navi end2-->
<div class="page-break"></div>

<!-- markdown\6-4-6.md -->
<!--navi start1-->
[前へ](#645-accept文の書き方5--日付時刻の取得)/[目次](https://opensourcecobol.github.io/markdown/TOC.html)/[次へ](#647-accept文の例外処理)
<!--navi end1-->
...
[ページトップへ](#646-accept文の書き方6--画面サイズデータの取得)
<!--navi end2-->
<div class="page-break"></div>

<!-- markdown\6-4-7.md -->
<!--navi start1-->
[前へ](#646-accept文の書き方6--画面サイズデータの取得)/[目次](https://opensourcecobol.github.io/markdown/TOC.html)/[次へ](#65-add)
<!--navi end1-->
### 6.4.7. ACCEPT文の例外処理
...
[ページトップへ](#647-accept文の例外処理)
<!--navi end2-->
<div class="page-break"></div>

<!-- markdown\6-5-1.md -->
<!--navi start1-->
[前へ](#647-accept文の例外処理)/[目次](https://opensourcecobol.github.io/markdown/TOC.html)/[次へ](#652-add文の書き方2--add-giving)
<!--navi end1-->
## 6.5. ADD
...
5. ONSIZE ERROR句を使うと、一意名-2の項目に格納される結果がその項目の容量を超えた場合に実行されるコードを指定することができる。例えば、PICTUREが99V99で、格納される結果が101.43の場合、SIZE ERROR条件が発生する。ON SIZE ERROR句がない場合、opensource COBOLは01.43の値を項目に格納する。ON SIZE ERROR句を使用すると、一意名-2項目の値は変更されずに、命令文-1が実行される。例として、デモプログラムとその出力を示した(図6-27)。<!--また、「EXCEPTION」組み込み関数についても説明している([6.1.7](#617-特殊レジスタ)参照)。-->
...
<!-- markdown\6-5-2.md -->
<!--navi start1-->
[前へ](#65-add)/[目次](https://opensourcecobol.github.io/markdown/TOC.html)/[次へ](#653-add文の書き方3--add-corresponding)
<!--navi end1-->
...
5. ROUNDED、LENGTH OF、ON SIZEERRORおよびNOTON SIZE ERROR句の使い方と動作は、[6.5.1](#65-add) ADD文の書き方1で説明している。

<!--navi start2-->

[ページトップへ](#652-add文の書き方2--add-giving)
<!--navi end2-->
<div class="page-break"></div>

<!-- markdown\6-5-3.md -->
<!--navi start1-->
[前へ](#652-add文の書き方2--add-giving)/[目次](https://opensourcecobol.github.io/markdown/TOC.html)/[次へ](#66-allocate)
<!--navi end1-->
...
1. 対応するものを識別するための規則については、[6.28.2](#6282-move文の書き方2--move-corresponding) – MOVE CORRESPONDINGで説明している。

2. ROUNDED、ON SIZEERRORおよびNOT ON SIZE ERROR句の使い方と動作は、[6.5.1](#65-add) ADD文の書き方1で説明している。

<!--navi start2-->

[ページトップへ](#653-add文の書き方3--add-corresponding)
<!--navi end2-->
<div class="page-break"></div>

<!-- markdown\6-6.md -->
<!--navi start1-->
[前へ](#653-add文の書き方3--add-corresponding)/[目次](https://opensourcecobol.github.io/markdown/TOC.html)/[次へ](#67-call)
<!--navi end1-->
## 6.6. ALLOCATE
...
4. RETURNING句は、割り当てられたメモリブロックのアドレスを、指定されたUSAGE POINTER項目に返す。そのUSAGE POINTER項目に対してFREE文([6.19](#619-free))が発生した場合に備え、opensource COBOLは割り当てられたメモリブロックが最初に要求されたサイズの情報を保持している。

5. 「一意名-1」オプションを使うと、INITIALIZEは一意名-1の定義に存在するPICTURE句およびVALUE句(存在する場合)に従って、割り当てられたメモリブロックを初期化する。INITIALIZE文については、[6.24](#624-initialize)で説明している。
...
<!-- markdown\6-7.md -->
<!--navi start1-->
[前へ](#66-allocate)/[目次](https://opensourcecobol.github.io/markdown/TOC.html)/[次へ](#68-cancel)
<!--navi end1-->
## 6.7. CALL
...
4. 定数-1またはindetifier-1の値は、呼び出しをするサブプログラムの記述項ポイントである。この記述項ポイントの使用方法の詳細については、[8.1.4](#814-動的にロード可能なサブプログラム)および[8.1.5](#815-静的サブルーチン)で説明する。

5. 一意名-1を使ってサブルーチンを呼び出すと、ランタイムシステムに、動的にロード可能なモジュールを呼び出すよう強制される。このモジュールについては、[8.1.4](#814-動的にロード可能なサブプログラム)で説明する。
...
14. その他詳細については[6.8](#68-cancel)(CANCEL)、[6.16](#616-entry)(ENTRY)、[6.18](#618-exit)(EXIT)、および[6.21](#621-goback)(GOBACK)で説明する。
...
<!-- markdown\6-8-1.md -->
<!--navi start1-->
[前へ](#67-call)/[目次](https://opensourcecobol.github.io/markdown/TOC.html)/[次へ](#682-cancel文の書き方2--cancel-all)
<!--navi end1-->
## 6.8. CANCEL
...
<!-- markdown\6-8-2.md -->
<!--navi start1-->
[前へ](#68-cancel)/[目次](https://opensourcecobol.github.io/markdown/TOC.html)/[次へ](#69-close)
<!--navi end1-->
...
[ページトップへ](#682-cancel文の書き方2--cancel-all)
<!--navi end2-->
<div class="page-break"></div>

<!-- markdown\6-9.md -->
<!--navi start1-->
[前へ](#682-cancel文の書き方2--cancel-all)/[目次](https://opensourcecobol.github.io/markdown/TOC.html)/[次へ](#610-commit)
<!--navi end1-->
## 6.9. CLOSE
...
<!-- markdown\6-10.md -->
<!--navi start1-->
[前へ](#69-close)/[目次](https://opensourcecobol.github.io/markdown/TOC.html)/[次へ](#611-compute)
<!--navi end1-->
## 6.10. COMMIT
...
1. 詳細についてはUNLOCK([6.48](#648-unlock))の章内で説明する。
...
<!-- markdown\6-11.md -->
<!--navi start1-->
[前へ](#610-commit)/[目次](https://opensourcecobol.github.io/markdown/TOC.html)/[次へ](#612-continue)
<!--navi end1-->
## 6.11. COMPUTE
...
2. ON SIZE ERROR、NOT ON SIZE ERROR、およびROUNDED句はコード化されており、ADD文で使われている同名義の句と同様に動作する([6.5.1](#65-add)を参照)。
...
<!-- markdown\6-12.md -->
<!--navi start1-->
[前へ](#611-compute)/[目次](https://opensourcecobol.github.io/markdown/TOC.html)/[次へ](#613-delete)
<!--navi end1-->
## 6.12. CONTINUE
...
1. CONTINUE文は、IF文([6.23](#623-if))とともに、まだ必要とされていないか、または未設計の条件付きで実行されるコードのプレースホルダーとして多用される。次の二つの文は同等である。CONTINUE文を使うことで、今後コード挿入の必要があるかもしれない場所をマークする。
...
[ページトップへ](#612-continue)
<!--navi end2-->
<div class="page-break"></div>

<!-- markdown\6-13-1.md -->
<!--navi start1-->
[前へ](#612-continue)/[目次](https://opensourcecobol.github.io/markdown/TOC.html)/[次へ](#6132-delete文の書き方2--delete-file)
<!--navi end1-->
## 6.13. DELETE
...
<!-- markdown\6-13-2.md -->
<!--navi start1-->
[前へ](#613-delete)/[目次](https://opensourcecobol.github.io/markdown/TOC.html)/[次へ](#614-display)
<!--navi end1-->
...
[ページトップへ](#6132-delete文の書き方2--delete-file)
<!--navi end2-->
<div class="page-break"></div>

<!-- markdown\6-14-1.md -->
<!--navi start1-->
[前へ](#6132-delete文の書き方2--delete-file)/[目次](https://opensourcecobol.github.io/markdown/TOC.html)/[次へ](#6142-display文の書き方2--コマンドライン引数へのアクセス)
<!--navi end1-->
## 6.14. DISPLAY
...
2. 指定する呼び名は、CONSOLE、CRT、PRINTER、またはこれらのうち1つに関連する特殊名段落内のユーザ定義の呼び名である必要がある([4.1.4](#414-特殊名段落)を参照)。このようなニーモニックはすべて、プログラムの実行元であるシェル(UNIX)またはコンソールウィンドウ(Windows)といった同じ宛先を指定します。
...
<!-- markdown\6-14-2.md -->
<!--navi start1-->
[前へ](#614-display)/[目次](https://opensourcecobol.github.io/markdown/TOC.html)/[次へ](#6143-display文の書き方3--環境変数へのアクセスまたは設定)
<!--navi end1-->
...
[ページトップへ](#6142-display文の書き方2--コマンドライン引数へのアクセス)
<!--navi end2-->
<div class="page-break"></div>

<!-- markdown\6-14-3.md -->
<!--navi start1-->
[前へ](#6142-display文の書き方2--コマンドライン引数へのアクセス)/[目次](https://opensourcecobol.github.io/markdown/TOC.html)/[次へ](#6144-display文の書き方4--画面データ)
<!--navi end1-->
...
3. DISPLAYの代わりにSET ENVIRONMENT([6.39.1](#639-set))を使用して環境変数を設定する方がはるかに簡単である。
 
<!--navi start2-->

[ページトップへ](#6143-display文の書き方3--環境変数へのアクセスまたは設定)
<!--navi end2-->
<div class="page-break"></div>

<!-- markdown\6-14-4.md -->
<!--navi start1-->
[前へ](#6143-display文の書き方3--環境変数へのアクセスまたは設定)/[目次](https://opensourcecobol.github.io/markdown/TOC.html)/[次へ](#6145-display文の例外処理)
<!--navi end1-->
...
3. SCROLLオプションについては、[6.4.4](#644-accept文の書き方4--画面データの取得)(ACCEPT文の書き方4 ― 画面データの取得)で説明している。

4. WITHオプションについては、[5.6](#56-画面記述)(画面記述)で説明している。

<!--navi start2-->

[ページトップへ](#6144-display文の書き方4--画面データ)
<!--navi end2-->
<div class="page-break"></div>

<!-- markdown\6-14-5.md -->
<!--navi start1-->
[前へ](#6144-display文の書き方4--画面データ)/[目次](https://opensourcecobol.github.io/markdown/TOC.html)/[次へ](#615-divide)
<!--navi end1-->
...
[ページトップへ](#6145-display文の例外処理)
<!--navi end2-->
<div class="page-break"></div>

<!-- markdown\6-15-1.md -->
<!--navi start1-->
[前へ](#6145-display文の例外処理)/[目次](https://opensourcecobol.github.io/markdown/TOC.html)/[次へ](#6152-divide文の書き方2--divide-into-giving)
<!--navi end1-->
## 6.15. DIVIDE
...
3. ON SIZE ERROR、NOT ON SIZE ERROR、およびROUNDED句はコード化されており、ADD文で使われている同名義の句と同様に動作する([6.5](#65-add)を参照)。
...
<!-- markdown\6-15-2.md -->
<!--navi start1-->
[前へ](#615-divide)/[目次](https://opensourcecobol.github.io/markdown/TOC.html)/[次へ](#6153-divide文の書き方3--divide-by-giving)
<!--navi end1-->
...
4. ON SIZE ERROR、NOT ON SIZE ERROR、およびROUNDED句はコード化されており、ADD文で使われている同名義の句と同様に動作する([6.5](#65-add)を参照)。

5. 一意名-1/定数-1の値がゼロの時、SIZE ERROR条件が発生する。除算の結果、小数点の左側に、受け取り項目での使用可能な数を超える桁数が必要な場合も同様である。

<!--navi start2-->

[ページトップへ](#6152-divide文の書き方2--divide-into-giving)
<!--navi end2-->
<div class="page-break"></div>

<!-- markdown\6-15-3.md -->
<!--navi start1-->
[前へ](#6152-divide文の書き方2--divide-into-giving)/[目次](https://opensourcecobol.github.io/markdown/TOC.html)/[次へ](#6154-divide文の書き方4--divide-into-remainder)
<!--navi end1-->
...
[ページトップへ](#6153-divide文の書き方3--divide-by-giving)
<!--navi end2-->
<div class="page-break"></div>

<!-- markdown\6-15-4.md -->
<!--navi start1-->
[前へ](#6153-divide文の書き方3--divide-by-giving)/[目次](https://opensourcecobol.github.io/markdown/TOC.html)/[次へ](#6155-divide文の書き方5--divide-by-remainder)
<!--navi end1-->
...
[ページトップへ](#6154-divide文の書き方4--divide-into-remainder)
<!--navi end2-->
<div class="page-break"></div>

<!-- markdown\6-15-5.md -->
<!--navi start1-->
[前へ](#6154-divide文の書き方4--divide-into-remainder)/[目次](https://opensourcecobol.github.io/markdown/TOC.html)/[次へ](#616-entry)
<!--navi end1-->
...
[ページトップへ](#6155-divide文の書き方5--divide-by-remainder)
<!--navi end2-->
<div class="page-break"></div>

<!-- markdown\6-16.md -->
<!--navi start1-->
[前へ](#6155-divide文の書き方5--divide-by-remainder)/[目次](https://opensourcecobol.github.io/markdown/TOC.html)/[次へ](#617-evaluate)
<!--navi end1-->
## 6.16. ENTRY
...
1. ネストされたサブプログラムでENTRY文を使うことはできない([2.1](#21-ネストされたユーザプログラム)を参照)。
...
<!-- markdown\6-17.md -->
<!--navi start1-->
[前へ](#616-entry)/[目次](https://opensourcecobol.github.io/markdown/TOC.html)/[次へ](#618-exit)
<!--navi end1-->
## 6.17. EVALUATE
...
[ページトップへ](#617-evaluate)
<!--navi end2-->
<div class="page-break"></div>

<!-- markdown\6-18.md -->
<!--navi start1-->
[前へ](#617-evaluate)/[目次](https://opensourcecobol.github.io/markdown/TOC.html)/[次へ](#619-free)
<!--navi end1-->
## 6.18. EXIT
...
4. EXIT PARAGRAPH文は、現在の段落の終わりを過ぎた時点に制御を移すが、EXIT SECTION文は、現在の節の最後の段落を過ぎた時点に制御を移す。
    ...
    EXIT PARAGRAPHまたはEXIT SECTIONが手続き型PERFORM([6.32.1](#632-perform))の範囲内の段落にある場合、制御はPERFORMに戻され、TIMES、VARYING、および/またはUNTIL句での評価が行われる。EXIT PARAGRAPHまたはEXIST SECTIONが手続き型PERFORMの範囲外にある場合、制御は次の段落(EXIT PARAGRAPH)または節(EXIT SECTION)の最初の実行可能な文に移る。図6-55は、EXIT PARAGRAPH文を使って、GO TOなしで図6-54の例をコーディングする方法を示している。

    図6-57-EXIT PARAGRAPH文<br>
    ![alt text](Image/6-57-Exit.png)

5. EXIT PERFORMおよびEXIT PERFORM CYCLE文は、インラインPERFORM文([6.32.2](#6322-perform文の書き方2--インライン型))と組み合わせて使うことを目的としている。
...
8. 最後に、EXIT PROGRAM文は、サブルーチン(つまり、別のプログラムによってCALLされているプログラム)の実行を終了し、CALLに続く文のCALLする側のプログラムに戻る。メインプログラムによって実行された場合は、EXIT PROGRAM文は機能しない。COBOL2002標準は、COBOL言語に共通の拡張を行った。それがGOBACK文([6.21](#621-goback))であり、EXIT PROGRAMの代わりとして検討すべきである。
...
<!-- markdown\6-19.md -->
<!--navi start1-->
[前へ](#618-exit)/[目次](https://opensourcecobol.github.io/markdown/TOC.html)/[次へ](#620-generate)
<!--navi end1-->
## 6.19. FREE
...
FREE文は、ALLOCATE文([6.6](#66-allocate))によってプログラムに割り当てられていたメモリを解放する。
...
<!-- markdown\6-20.md -->
<!--navi start1-->
[前へ](#619-free)/[目次](https://opensourcecobol.github.io/markdown/TOC.html)/[次へ](#621-goback)
<!--navi end1-->
## 6.20. GENERATE
...
[ページトップへ](#620-generate)
<!--navi end2-->
<div class="page-break"></div>

<!-- markdown\6-21.md -->
<!--navi start1-->
[前へ](#620-generate)/[目次](https://opensourcecobol.github.io/markdown/TOC.html)/[次へ](#622-go-to)
<!--navi end1-->
## 6.21. GOBACK
...
2. メインプログラム内で実行された場合、GOBACKはSTOP RUN文として機能する([6.42](#642-stop))。
...
<!-- markdown\6-22-1.md -->
<!--navi start1-->
[前へ](#621-goback)/[目次](https://opensourcecobol.github.io/markdown/TOC.html)/[次へ](#6222-go-to文の書き方2--go-to-depending-on)
<!--navi end1-->
## 6.22. GO TO
...
<!-- markdown\6-22-2.md -->
<!--navi start1-->
[前へ](#622-go-to)/[目次](https://opensourcecobol.github.io/markdown/TOC.html)/[次へ](#623-if)
<!--navi end1-->
...
[ページトップへ](#6222-go-to文の書き方2--go-to-depending-on)
<!--navi end2-->
<div class="page-break"></div>

<!-- markdown\6-23.md -->
<!--navi start1-->
[前へ](#6222-go-to文の書き方2--go-to-depending-on)/[目次](https://opensourcecobol.github.io/markdown/TOC.html)/[次へ](#624-initialize)
<!--navi end1-->
## 6.23. IF
...
3. ピリオド(.)とEND-IF文について、IF文の範囲を終了できる方法が互いにどのように類似しているか、または異なっているかを、[6.1.5](#615-ピリオド)で例を挙げて説明している。
...
<!-- markdown\6-24.md -->
<!--navi start1-->
[前へ](#623-if)/[目次](https://opensourcecobol.github.io/markdown/TOC.html)/[次へ](#625-initiate)
<!--navi end1-->
## 6.24. INITIALIZE
...
2. 一意名-1項目の定義内、また、一意名-1項目に従属する項目にOCCUR DEPENDING ON句([5.3](#53-データ記述の形式)参照)を含めることはできない。
...
[ページトップへ](#624-initialize)
<!--navi end2-->
<div class="page-break"></div>

<!-- markdown\6-25.md -->
<!--navi start1-->
[前へ](#624-initialize)/[目次](https://opensourcecobol.github.io/markdown/TOC.html)/[次へ](#626-inspect)
<!--navi end1-->
## 6.25. INITIATE
...
[ページトップへ](#625-initiate)
<!--navi end2-->
<div class="page-break"></div>

<!-- markdown\6-26.md -->
<!--navi start1-->
[前へ](#625-initiate)/[目次](https://opensourcecobol.github.io/markdown/TOC.html)/[次へ](#627-merge)
<!--navi end1-->
## 6.26. INSPECT
...
REPLACING句は、文字列内の部分文字列を、同じ長さで内容の異なるものに置き換えるために用いられる。1つ以上の部分文字列を、長さも内容も異なる他の部分文字列に置き換える必要がある場合は、SUBSTITUTE組み込み関数([6.1.7](#617-特殊レジスタ)参照)を使用すると良い。
...
8. INSPECT文は1985年のCOBOL標準で導入されたため、TRANSFORM文([6.47](#647-transform))は廃止された。
...
<!-- markdown\6-27.md -->
<!--navi start1-->
[前へ](#626-inspect)/[目次](https://opensourcecobol.github.io/markdown/TOC.html)/[次へ](#628-move)
<!--navi end1-->
## 6.27. MERGE
...
1. MERGE文で指定された整列ファイルは、データ部のファイル節でソート記述(SD)を使って定義する必要がある。[5.2](#52-整列用記述)では説明の残りの部分で、このファイルを「マージファイル」と呼んでいる。

2. ファイル名-1、ファイル名-2、およびファイル名-3(指定されている場合)は、ORGANIZATION LINE SEQUENTIALまたはORGANIZATION RECORD BINARY SEQUENTIALファイルを参照する必要がある。これらのファイルは、データ部のファイル節でファイル記述(FD)を使って定義しなければならない。[5.1](#51-ファイル記述)ではファイル名-1とファイル名-2で同じファイルが使われている。
...
11. OUTPUT PROCEDUREを使用する場合、マージされたレコードはRETURN文([6.35](#635-return))を用いて、マージファイルから一つずつ手動で読み取られる。
...
15. OUTPUT PROCEDUREの範囲では、ファイルのSORT文([6.40.1](#640-sort))、MERGE文、またはRELEASE文([6.34](#634-release))を実行してはならない。

---
`21` [4.2.2](#422-入出力管理段落)参照。
...
<!-- markdown\6-28-1.md -->
<!--navi start1-->
[前へ](#627-merge)/[目次](https://opensourcecobol.github.io/markdown/TOC.html)/[次へ](#6282-move文の書き方2--move-corresponding)
<!--navi end1-->
## 6.28. MOVE
...
<!-- markdown\6-28-2.md -->
<!--navi start1-->
[前へ](#628-move)/[目次](https://opensourcecobol.github.io/markdown/TOC.html)/[次へ](#629-multiply)
<!--navi end1-->
...
[ページトップへ](#6282-move文の書き方2--move-corresponding)
<!--navi end2-->
<div class="page-break"></div>

<!-- markdown\6-29-1.md -->
<!--navi start1-->
[前へ](#6282-move文の書き方2--move-corresponding)/[目次](https://opensourcecobol.github.io/markdown/TOC.html)/[次へ](#6292-multiply文の書き方2--multiply-giving)
<!--navi end1-->
## 6.29. MULTIPLY
...
4. ON SIZE ERROR、NOT ON SIZE ERROR、およびROUNDED句はコード化され、ADD文での同名義句と同様に動作する([6.5](#65-add)参照)。

<!--navi start2-->

[ページトップへ](#629-multiply)
<!--navi end2-->
<div class="page-break"></div>

<!-- markdown\6-29-2.md -->
<!--navi start1-->
[前へ](#629-multiply)/[目次](https://opensourcecobol.github.io/markdown/TOC.html)/[次へ](#630-next-sentence)
<!--navi end1-->
...
5. ON SIZE ERROR、NOT ON SIZE ERROR、およびROUNDED句はコード化され、ADD文での同名義句と同様に動作する([6.5](#65-add)参照)。

<!--navi start2-->

[ページトップへ](#6292-multiply文の書き方2--multiply-giving)
<!--navi end2-->
<div class="page-break"></div>

<!-- markdown\6-30.md -->
<!--navi start1-->
[前へ](#6292-multiply文の書き方2--multiply-giving)/[目次](https://opensourcecobol.github.io/markdown/TOC.html)/[次へ](#631-open)
<!--navi end1-->
## 6.30. NEXT SENTENCE
...
3. 1985年より前の標準に従ってコーディングされたCOBOLプログラムにNEXT SENTENCE文が必要な理由については、[6.1.5](#615-ピリオド)で説明している。また、1985年(およびそれ以降)の標準用にコーディングされたプログラムがこの文を必要としない理由もわかるだろう。

4. 新しいopensource COBOLプログラムは、IF文にEND-IFスコープターミネータを使ってコーディングする必要がある。これにより、CONTINUE文([6.12](#612-continue))を優先することでNEXT SENTENCEの使用が無効となる。

<!--navi start2-->

[ページトップへ](#630-next-sentence)
<!--navi end2-->
<div class="page-break"></div>

<!-- markdown\6-31.md -->
<!--navi start1-->
[前へ](#630-next-sentence)/[目次](https://opensourcecobol.github.io/markdown/TOC.html)/[次へ](#632-perform)
<!--navi end1-->
## 6.31. OPEN
...
1. opensource COBOLプログラムで定義されたファイルは、CLOSE文([6.9](#69-close))、DELETE文([6.13](#613-delete))、READ文([6.33](#633-read))、START文([6.41](#641-start))、またはUNLOCK文([6.48](#648-unlock))で参照される前に、正常にOPENされている必要がある。更に、ファイルのレコードデータ名(またはレコードに従属するデータ要素)をANY文で参照するためには、ファイルが正常にOPENされていなければならない。

2. 既に開いているファイルを開こうとすると、ファイルステータス41(「ファイルは既に開いています」)で失敗となり、これはプログラムを終了させてしまう致命的なエラーとなる。

3. OPENの失敗(「ファイルは既に開いています」を含む)は、DECLARATIVES([6.3](#63-宣言の記述形式))またはエラープロシージャ<!--(7.3.2)-->を使って処理できるが、トラップルーチンが終了してしまうと、opensource COBOLランタイムシステムはプログラムを終了し、最終的にOPEN障害から回復することはできない。
...
5. SHARING句は、同じファイルを開こうとする他のopensource COBOLプログラムと自分のプログラムがどのように共存するかをopensource COBOLに通知する。このオプションについては[6.1.8.1](#6181-ファイル共有)で説明している。
...
<!-- markdown\6-32-1.md -->
<!--navi start1-->
[前へ](#631-open)/[目次](https://opensourcecobol.github.io/markdown/TOC.html)/[次へ](#6322-perform文の書き方2--インライン型)
<!--navi end1-->
## 6.32. PERFORM
...
<!-- markdown\6-32-2.md -->
<!--navi start1-->
[前へ](#632-perform)/[目次](https://opensourcecobol.github.io/markdown/TOC.html)/[次へ](#633-read)
<!--navi end1-->
...
[ページトップへ](#6322-perform文の書き方2--インライン型)
<!--navi end2-->
<div class="page-break"></div>

<!-- markdown\6-33-1.md -->
<!--navi start1-->
[前へ](#6322-perform文の書き方2--インライン型)/[目次](https://opensourcecobol.github.io/markdown/TOC.html)/[次へ](#6332-read文の書き方2--ランダム読み取り)
<!--navi end1-->
## 6.33. READ
...
1. ファイル名-1は、INPUTまたはI-Oに対して常にOPEN([6.31](#631-open))である必要がある。
...
5. ファイル名-1で次に使用可能なレコードが取得され、その内容はファイルのFD([5.1](#51-ファイル記述))に従属する01レベルのレコード構造に格納される。
...
9. レコードのLOCK句については[6.1.8.2](#6182-レコードロック)で説明している。

10. AT END句が存在する場合、ファイルステータスが10「ファイルの終わり」であることが原因でREADの試行が失敗した時に命令文1を実行する。AT END句は、**_ゼロ以外のファイルステータス値を検出しないため、_**DECLARATIVESルーチン([6.3](#63-宣言の記述形式))またはREAD後に明示的に宣言されたファイルステータス項目を使って、ファイルの終わり以外のエラー状態を検出する。
...
<!-- markdown\6-33-2.md -->
<!--navi start1-->
[前へ](#633-read)/[目次](https://opensourcecobol.github.io/markdown/TOC.html)/[次へ](#634-release)
<!--navi end1-->
...
6. 5項で識別されるレコードはファイル名-1から取得され、その内容はファイルのFD([5.1](#51-ファイル記述))に従属する01レベルのレコード構造に格納される。

7. INTO句を使うと、読み取りが成功した場合、読み取ったレコード内容がMOVEの規則に従って一意名-1にMOVEされる。

8. レコードのLOCK句については[6.1.8.2](#6182-レコードロック)で説明している。

9. INVALID KEY句が存在する場合、ファイルステータスが23「キーが存在しない」であることが原因でREADの試行が失敗した時に命令文1を実行する。INVALID KEY句は、**_ゼロ以外のファイルステータス値を検出しないため、_** DECLARATIVESルーチン([6.3](#63-宣言の記述形式))またはREAD後に明示的に宣言されたファイルステータス項目を使って、「キーが存在しない」以外のエラー状態を検出する。

10. NOT INVALID KEY句が存在する場合、READの試行が成功すると、命令文2が実行される。

<!--navi start2-->

[ページトップへ](#6332-read文の書き方2--ランダム読み取り)
<!--navi end2-->
<div class="page-break"></div>

<!-- markdown\6-34.md -->
<!--navi start1-->
[前へ](#6332-read文の書き方2--ランダム読み取り)/[目次](https://opensourcecobol.github.io/markdown/TOC.html)/[次へ](#635-return)
<!--navi end1-->
## 6.34. RELEASE
...
1. RELEASE文は、SORT文のINPUT PROCEDURE内でのみ有効である([6.40.1](#640-sort)参照)。

2. レコード名-1は、ソート記述(SD)記述項に定義されたレコードでなければならない([5.2](#52-整列用記述)参照)。
...
<!-- markdown\6-35.md -->
<!--navi start1-->
[前へ](#634-release)/[目次](https://opensourcecobol.github.io/markdown/TOC.html)/[次へ](#636-rewrite)
<!--navi end1-->
## 6.35. RETURN
...
1. RETURN文は、SORT文([6.40.1](#640-sort))またはMERGE文([6.27](#627-merge))のOUTPUT PROCEDURE内でのみ有効である。

2. ファイル名-1は、ソート記述(SD)記述項で定義された整列ファイルまたはマージファイルでなければならない([5.2](#52-整列用記述)参照)。

3. INTO、AT END、およびNOT AT END句は、READ文([6.33](#633-read))と同様にして扱われる。
...
<!-- markdown\6-36.md -->
<!--navi start1-->
[前へ](#635-return)/[目次](https://opensourcecobol.github.io/markdown/TOC.html)/[次へ](#637-rollback)
<!--navi end1-->
## 6.36. REWRITE
...
1. レコード名-1は、I-Oに対して現在OPEN([6.31](#631-open))になっているファイルのファイル記述(FD – [5.1](#51-ファイル記述)参照)に従属する01レベルのレコードとして定義される必要がある。
...
4. レコードのLOCK句については[6.1.8.2](#6182-レコードロック)で説明している。

5. レコードを書き換えても、ファイルの次のブロックが読み取られるか、COMMIT文([6.10](#610-commit))が発行されるか、そのファイルが閉じられるまで、ファイルのレコードの内容は物理的に更新されない。

6. ファイルにORGANIZATION RECORD BINARY SEQUENTIALがある場合：

    a. 書き換えられるレコードは、ファイルの最後に実行されたREAD文([6.33](#633-read))によって取得されたレコードとなる。

    b. レコード名-1のサイズは変更できません([5.1](#51-ファイル記述)のRECORD CONTAINS/RECORD IS VARYING句を参照)。

7. ファイルにORGANIZATION RELATIVEまたはORGANIZATION INDEXEDがある場合：

    a. ACCESS MODE SEQUENTIALがある場合、書き換えられるレコードは、ファイルの最後に実行されたREAD文([6.33](#633-read))によって取得されたレコードとなる。ACCESS MODE RANDOMまたはACCESS MODE DYNAMICがある場合、レコードを書き換える前のREAD文は必要ない。ファイルのRELATIVE KEY/RECORD KEY定義で、更新するレコードを指定する。
...
<!-- markdown\6-37.md -->
<!--navi start1-->
[前へ](#636-rewrite)/[目次](https://opensourcecobol.github.io/markdown/TOC.html)/[次へ](#638-search)
<!--navi end1-->
## 6.37. ROLLBACK
...
1. opensource COBOLは(少なくとも今現在)ファイルのロールバックをサポートしていない。ROLLBACK文は、COMMIT文([6.10](#610-commit))と同じ働きをする。

<!--navi start2-->

[ページトップへ](#637-rollback)
<!--navi end2-->
<div class="page-break"></div>

<!-- markdown\6-38-1.md -->
<!--navi start1-->
[前へ](#637-rollback)/[目次](https://opensourcecobol.github.io/markdown/TOC.html)/[次へ](#6382-search文の書き方2--二分探索search-all)
<!--navi end1-->
## 6.38. SEARCH
...
2. VARYING句が指定されていない場合、探索対象のテーブルはINDEXED BY句([5.3](#53-データ記述の形式)を参照)を用いて作成する必要がある。
...
<!-- markdown\6-38-2.md -->
<!--navi start1-->
[前へ](#638-search)/[目次](https://opensourcecobol.github.io/markdown/TOC.html)/[次へ](#639-set)
<!--navi end1-->
...
[ページトップへ](#6382-search文の書き方2--二分探索search-all)
<!--navi end2-->
<div class="page-break"></div>

<!-- markdown\6-39-1.md -->
<!--navi start1-->
[前へ](#6382-search文の書き方2--二分探索search-all)/[目次](https://opensourcecobol.github.io/markdown/TOC.html)/[次へ](#6392-set文の書き方2--プログラムポインター設定)
<!--navi end1-->
## 6.39. SET
...
2. 環境変数を設定する手段としては、DISPLAY文([6.14.3](#6143-display文の書き方3--環境変数へのアクセスまたは設定))を使うよりも、この方法は遥かに簡単で読みやすい。例えば、次の二つのコード順序は同じ結果を示す。
...
<!-- markdown\6-39-2.md -->
<!--navi start1-->
[前へ](#639-set)/[目次](https://opensourcecobol.github.io/markdown/TOC.html)/[次へ](#6393-set文の書き方3--アドレス設定)
<!--navi end1-->
...
4. この方法で手続き部コード領域のアドレスを取得すると、そのアドレスをサブルーチン(通常はCで書かれる)に渡して、必要な用途に使うことができる。動作中のプログラムポインターの例については、[8.3.1.23](#83123-call-cbl_error_proc-using-function-program-pointer)および[8.3.1.24](#83124-call-cbl_exit_proc-using-function-program-pointer)で説明する。

<!--navi start2-->

[ページトップへ](#6392-set文の書き方2--プログラムポインター設定)
<!--navi end2-->
<div class="page-break"></div>

<!-- markdown\6-39-3.md -->
<!--navi start1-->
[前へ](#6392-set文の書き方2--プログラムポインター設定)/[目次](https://opensourcecobol.github.io/markdown/TOC.html)/[次へ](#6394-set文の書き方4--インデックス設定)
<!--navi end1-->
...
[ページトップへ](#6393-set文の書き方3--アドレス設定)
<!--navi end2-->
<div class="page-break"></div>

<!-- markdown\6-39-4.md -->
<!--navi start1-->
[前へ](#6393-set文の書き方3--アドレス設定)/[目次](https://opensourcecobol.github.io/markdown/TOC.html)/[次へ](#6395-set文の書き方5--updown-設定)
<!--navi end1-->
...
[ページトップへ](#6394-set文の書き方4--インデックス設定)
<!--navi end2-->
<div class="page-break"></div>

<!-- markdown\6-39-5.md -->
<!--navi start1-->
[前へ](#6394-set文の書き方4--インデックス設定)/[目次](https://opensourcecobol.github.io/markdown/TOC.html)/[次へ](#6396-set文の書き方6--条件名設定)
<!--navi end1-->
...
[ページトップへ](#6395-set文の書き方5--updown-設定)
<!--navi end2-->
<div class="page-break"></div>

<!-- markdown\6-39-6.md -->
<!--navi start1-->
[前へ](#6395-set文の書き方5--updown-設定)/[目次](https://opensourcecobol.github.io/markdown/TOC.html)/[次へ](#6397-set文の書き方7--スイッチ設定)
<!--navi end1-->
...
[ページトップへ](#6396-set文の書き方6--条件名設定)
<!--navi end2-->
<div class="page-break"></div>

<!-- markdown\6-39-7.md -->
<!--navi start1-->
[前へ](#6396-set文の書き方6--条件名設定)/[目次](https://opensourcecobol.github.io/markdown/TOC.html)/[次へ](#640-sort)
<!--navi end1-->
...
1. スイッチは、特殊名段落を使って定義される。詳細については、[4.1.4](#414-特殊名段落)で説明している。

<!--navi start2-->

[ページトップへ](#6397-set文の書き方7--スイッチ設定)
<!--navi end2-->
<div class="page-break"></div>

<!-- markdown\6-40-1.md -->
<!--navi start1-->
[前へ](#6397-set文の書き方7--スイッチ設定)/[目次](https://opensourcecobol.github.io/markdown/TOC.html)/[次へ](#6402-sort文の書き方2--テーブルソート)
<!--navi end1-->
## 6.40. SORT
...
1. SORT文で指定された整列ファイルは、データ部のファイル節でソート記述(SD)を使用って定義する必要がある([5.2](#52-整列用記述)を参照)。このファイルは「整列ファイル」と呼ばれる。

2. 指定する場合、ファイル名-1およびファイル名-2は、ORGANIZATION LINE SEQUENTIALまたはORGANIZATION RECORD BINARY SEQUENTIALファイルを参照する必要がある。これらのファイルは、データ部のファイル節のファイル記述(FD)を使って定義する必要がある([5.1](#51-ファイル記述)を参照)。ファイル名-1とファイル名-2に同じファイルを使うことができる。
...
6. SORT文は次の3段階の働きがある。
    ...
    c. INPUT PROCEDUREを使うと、整列されるレコードは必要なロジックを用いて生成され、RELEASE文([6.34](#634-release))を使うことで整列ファイルに一度につき一つずつ手動で書き込まれる。
    ...
    h. INPUT PROCEDUREの範囲内では、ファイルのSORT、MERGE([6.27](#627-merge))、またはRETURN([6.35](#635-return))を実行できない。
    ...
    c. OUTPUT PROCEDUREを使用する場合、整列済みレコードは、RETURN文([6.35](#635-return))を使うことで整列ファイルに一度につき一つずつ手動で読み取られる。
    ...
    g. OUTPUT PROCEDUREの範囲内では、ファイルのSORT、MERGE([6.27](#627-merge))、またはRELEASE([6.34](#634-release))を実行できない。

7. 整列されるデータの量によってディスク作業ファイルが必要な場合、TMPDIR、TMP、またはTEMP環境変数([7.2.4](#72-日本語項目と表意定数)を参照)によって定義されたフォルダー内のディスクに自動的に割り当てられる。ディスクファイルは、プログラムの実行終了時に自動的にパージされることはない。一時的な整列用ファイルは、自分で、または整列の終了時にプログラム内から削除する場合に備えて、「cobxxxx.tmp」という名前が付けられる。

---
`24` 整列プロセスにはメモリを割り当てるためのランタイム環境変数(COB_SORT_MEMORY)がある([7.2.4](#72-日本語項目と表意定数)を参照)。
...
<!-- markdown\6-40-2.md -->
<!--navi start1-->
[前へ](#640-sort)/[目次](https://opensourcecobol.github.io/markdown/TOC.html)/[次へ](#641-start)
<!--navi end1-->
...
[ページトップへ](#6402-sort文の書き方2--テーブルソート)
<!--navi end2-->
<div class="page-break"></div>

<!-- markdown\6-41.md -->
<!--navi start1-->
[前へ](#6402-sort文の書き方2--テーブルソート)/[目次](https://opensourcecobol.github.io/markdown/TOC.html)/[次へ](#642-stop)
<!--navi end1-->
## 6.41. START
...
3. ファイル名-1はSTART文の実行時に、INPUTモードまたはI-OモードのいずれかでOPEN([6.31](#631-open))の状態である必要がある。

4. KEY句が指定されていない場合、「**KEY IS EQUAL TO** 一意名-1」が指定されたとみなす。

5. ファイル名-1がORGANIZATION RELATIVEファイルの場合、一意名-1はファイルのRELATIVE KEYでなければならない([4.2.1.2](#4212-相対編成ファイル)を参照)。

6. ファイル名-1がORGANIZATION INDEXEDファイルの場合、一意名-1はファイルのRECORD KEYまたはALTERNATE RECORD KEY項目の一つでなければならない([4.2.1.3](#4213-索引編成ファイル)を参照)。
...
<!-- markdown\6-42.md -->
<!--navi start1-->
[前へ](#641-start)/[目次](https://opensourcecobol.github.io/markdown/TOC.html)/[次へ](#643-string)
<!--navi end1-->
## 6.42. STOP
...
<!-- markdown\6-43.md -->
<!--navi start1-->
[前へ](#642-stop)/[目次](https://opensourcecobol.github.io/markdown/TOC.html)/[次へ](#644-subtract)
<!--navi end1-->
## 6.43. STRING
...
8. 受け取り項目(一意名-3)は、STRING文の開始時に(SPACESまたはその他の値に)初期化されることも、コピーされる送信項目の文字総数が受け取り項目のサイズよりも少ない場合にSPACEで埋められることもない。必要に応じて、STRINGを実行する前に受け取り項目を自分で明示的にINITIALIZE文([6.24](#624-initialize))を使って初期化することができる。
...
<!-- markdown\6-44-1.md -->
<!--navi start1-->
[前へ](#643-string)/[目次](https://opensourcecobol.github.io/markdown/TOC.html)/[次へ](#6442-subtract文の書き方2--subtract-giving)
<!--navi end1-->
## 6.44. SUBTRACT
...
3. ROUNDED、ON SIZE ERRORおよびNOT ON SIZE ERROR句は、ADD文([6.5.1](#65-add))の場合と同じように使われる。

<!--navi start2-->

[ページトップへ](#644-subtract)
<!--navi end2-->
<div class="page-break"></div>

<!-- markdown\6-44-2.md -->
<!--navi start1-->
[前へ](#644-subtract)/[目次](https://opensourcecobol.github.io/markdown/TOC.html)/[次へ](#6443-subtract文の書き方3--subtract-corresponding)
<!--navi end1-->
...
4. ROUNDED、ON SIZE ERRORおよびNOT ON SIZE ERROR句は、ADD文([6.5.1](#65-add))の場合と同じように使われる。

<!--navi start2-->

[ページトップへ](#6442-subtract文の書き方2--subtract-giving)
<!--navi end2-->
<div class="page-break"></div>

<!-- markdown\6-44-3.md -->
<!--navi start1-->
[前へ](#6442-subtract文の書き方2--subtract-giving)/[目次](https://opensourcecobol.github.io/markdown/TOC.html)/[次へ](#645-suppress)
<!--navi end1-->
...
1. 対応する一致を識別するためのルールは、[6.28.2](#6282-move文の書き方2--move-corresponding) ― MOVE CORRESPONDINGで説明している。

2. ROUNDED、ON SIZE ERRORおよびNOT ON SIZE ERROR句は、ADD文([6.5.1](#65-add))の場合と同じように使われる。

<!--navi start2-->

[ページトップへ](#6443-subtract文の書き方3--subtract-corresponding)
<!--navi end2-->
<div class="page-break"></div>

<!-- markdown\6-45.md -->
<!--navi start1-->
[前へ](#6443-subtract文の書き方3--subtract-corresponding)/[目次](https://opensourcecobol.github.io/markdown/TOC.html)/[次へ](#646-terminate)
<!--navi end1-->
## 6.45. SUPPRESS
...
[ページトップへ](#645-suppress)
<!--navi end2-->
<div class="page-break"></div>

<!-- markdown\6-46.md -->
<!--navi start1-->
[前へ](#645-suppress)/[目次](https://opensourcecobol.github.io/markdown/TOC.html)/[次へ](#647-transform)
<!--navi end1-->
## 6.46. TERMINATE
...
[ページトップへ](#646-terminate)
<!--navi end2-->
<div class="page-break"></div>

<!-- markdown\6-47.md -->
<!--navi start1-->
[前へ](#646-terminate)/[目次](https://opensourcecobol.github.io/markdown/TOC.html)/[次へ](#648-unlock)
<!--navi end1-->
## 6.47. TRANSFORM
...
3. TRANSFORM文は1985年のCOBOL標準で廃止され、その機能はINSPECT文、具体的にはCONVERTING句([6.26](#626-inspect))に含まれている。
...
[ページトップへ](#647-transform)
<!--navi end2-->
<div class="page-break"></div>

<!-- markdown\6-48.md -->
<!--navi start1-->
[前へ](#647-transform)/[目次](https://opensourcecobol.github.io/markdown/TOC.html)/[次へ](#649-unstring)
<!--navi end1-->
## 6.48. UNLOCK
...
<!-- markdown\6-49.md -->
<!--navi start1-->
[前へ](#648-unlock)/[目次](https://opensourcecobol.github.io/markdown/TOC.html)/[次へ](#650-write)
<!--navi end1-->
## 6.49. UNSTRING
...
[ページトップへ](#649-unstring)
<!--navi end2-->
<div class="page-break"></div>

<!-- markdown\6-50.md -->
<!--navi start1-->
[前へ](#649-unstring)/[目次](https://opensourcecobol.github.io/markdown/TOC.html)/[次へ](#7-日本語の使用)
<!--navi end1-->
## 6.50. WRITE
...
1. レコード名-1は、OUTPUT、I-OまたはEXTENDに対して、現在もOPEN([6.31](#631-open))状態であるファイルの、ファイル記述(FD－[5.1](#5-データ部)を参照)に従属する01レベルのレコードとして定義する必要がある。
...
4. レコードのLOCKオプションについては[6.1.8.2](#6182-レコードロック)で説明している。
...
9. 書き込まれるファイルのFDにLINAGE句([5.1](#51-ファイル記述))が含まれている場合、内部のラインカウンターはランタイムライブラリによって維持され、LINAGE定義のLINES AT TOPおよび/またはLINES AT BOTTOM指定に対応するかたちで、適切な数のASCII改行文字がファイルに自動的に書き込まれる。

10. AT END-OF-PAGE句とNOT AT END-OF-PAGE句は、ファイル記述にLINAGE句が含まれているORGANIZATION LINE SEQUENTIALまたはORGANIZATION RECORD BINARY SEQUENTIALファイルに対してのみ有効である([5.1](#5-データ部))。
...
<!-- markdown\7-1.md -->
<!--navi start1-->
[前へ](#650-write)/[目次](https://opensourcecobol.github.io/markdown/TOC.html)/[次へ](#72-日本語項目と表意定数)
<!--navi end1-->
# 7. 日本語の使用
...
<!-- markdown\7-2.md -->
<!--navi start1-->
[前へ](#7-日本語の使用)/[目次](https://opensourcecobol.github.io/markdown/TOC.html)/[次へ](#73-各命令文と日本語の取扱い)
<!--navi end1-->
## 7.2. 日本語項目と表意定数
...
[ページトップへ](#72-日本語項目と表意定数)
<!--navi end2-->
<div class="page-break"></div>

<!-- markdown\7-3-1.md -->
<!--navi start1-->
[前へ](#72-日本語項目と表意定数)/[目次](https://opensourcecobol.github.io/markdown/TOC.html)/[次へ](#732-acceptdisplay文)
<!--navi end1-->
## 7.3. 各命令文と日本語の取扱い
...
[ページトップへ](#73-各命令文と日本語の取扱い)
<!--navi end2-->
<div class="page-break"></div>

<!-- markdown\7-3-2.md -->
<!--navi start1-->
[前へ](#73-各命令文と日本語の取扱い)/[目次](https://opensourcecobol.github.io/markdown/TOC.html)/[次へ](#74-utf-8の使用)
<!--navi end1-->
### 7.3.2. ACCEPT/DISPLAY文

ACCEPT文とDIPLAY文による日本語データの入出力も、実質的には、PICTURE句([5.3](#53-データ記述の形式))および本章の英数字項目の日本語([7.1](#71-英数字項目の日本語))とMOVE文([7.3.1](#731-move文))の規則に従って処理される。
...
[ページトップへ](#732-acceptdisplay文)
<!--navi end2-->
<div class="page-break"></div>

<!-- markdown\7-4.md -->
<!--navi start1-->
[前へ](#732-acceptdisplay文)/[目次](https://opensourcecobol.github.io/markdown/TOC.html)/[次へ](#8-opensource-cobolシステムインターフェース)
<!--navi end1-->
## 7.4. UTF-8の使用
...
<!-- markdown\8-1-1.md -->
<!--navi start1-->
[前へ](#74-utf-8の使用)/[目次](https://opensourcecobol.github.io/markdown/TOC.html)/[次へ](#812-コンパイルオプション)
<!--navi end1-->
...
プログラムのファイル名はPROGRAM-IDの指定(大文字と小文字を含む)と<u>完全に</u>一致しなければならない。この理由については[3章](#3-見出し部)で説明している。
...
[ページトップへ](#8-opensource-cobolシステムインターフェース)
<!--navi end2-->
<div class="page-break"></div>

<!-- markdown\8-1-2.md -->
<!--navi start1-->
[前へ](#8-opensource-cobolシステムインターフェース)/[目次](https://opensourcecobol.github.io/markdown/TOC.html)/[次へ](#813-実行可能プログラムのコンパイル)
<!--navi end1-->
### 8.1.2. コンパイルオプション
...
[2章](#2-opensource-cobolのプログラム形式)で説明したように、プログラムコンパイルユニットは、単一のソースファイルで順番に定義された複数のプログラムで構成されている場合がある。「cobc」コマンドで複数のソースファイルを指定することにより、「cobc」コマンドを1回実行するだけで複数のコンパイルユニットを処理することが可能になる。

<!--navi start2-->

[ページトップへ](#812-コンパイルオプション)
<!--navi end2-->
<div class="page-break"></div>

<!-- markdown\8-1-3.md -->
<!--navi start1-->
[前へ](#812-コンパイルオプション)/[目次](https://opensourcecobol.github.io/markdown/TOC.html)/[次へ](#814-動的にロード可能なサブプログラム)
<!--navi end1-->
...
[ページトップへ](#813-実行可能プログラムのコンパイル)
<!--navi end2-->
<div class="page-break"></div>

<!-- markdown\8-1-4.md -->
<!--navi start1-->
[前へ](#813-実行可能プログラムのコンパイル)/[目次](https://opensourcecobol.github.io/markdown/TOC.html)/[次へ](#815-静的サブルーチン)
<!--navi end1-->
...
4. プログラムが動的にロード可能なモジュール内のサブプログラムを呼び出すとき
    ...
    a. opensource COBOLランタイムライブラリは、現在ロードされている動的にロード可能なすべてのモジュールで、サブプログラムの記述項ポイントを検索する(記述項ポイントは、CALL文でコード化された定数または一意名([6.7](#67-call)を参照))。その記述項ポイントは、動的にロード可能なモジュールを作成したソースファイル内のPROGRAM-ID([3章](#3-見出し部))または記述項ポイント([6.16章](#616-entry))のいずれかとして定義される。
...
「**-x**」オプションではなく「**-m**」オプション(上記コマンド参照)を使って、動的にロード可能なライブラリとしてメインプログラムを生成することも可能である。これらのメインプログラムを実行するには、[8.2.2](#822-cobcrunユーティリティの使用)で説明しているように、cobcrunコマンドを使う必要がある。

<!--navi start2-->

[ページトップへ](#814-動的にロード可能なサブプログラム)
<!--navi end2-->
<div class="page-break"></div>

<!-- markdown\8-1-5.md -->
<!--navi start1-->
[前へ](#814-動的にロード可能なサブプログラム)/[目次](https://opensourcecobol.github.io/markdown/TOC.html)/[次へ](#816-cobolとcプログラムの結合)
<!--navi end1-->
### 8.1.5. 静的サブルーチン
...
[ページトップへ](#815-静的サブルーチン)
<!--navi end2-->
<div class="page-break"></div>

<!-- markdown\8-1-6.md -->
<!--navi start1-->
[前へ](#815-静的サブルーチン)/[目次](https://opensourcecobol.github.io/markdown/TOC.html)/[次へ](#817-重要な環境変数)
<!--navi end1-->
...
| BINARY-C-LONG SIGNED | 4バイトまたは8バイト | -2147483648 ~ +2147483647または-9223372036854775808 ~ +9223372036854775807| long(USAGE BINARY-C-LONGの[表5-10](#53-データ記述の形式)を参照)  |
...
[6.7](#67-call)で説明したように、サブプログラムがopensource COBOL以外の言語で記述されている場合、opensource COBOLのサブプログラム呼び出しでは、BY CONTENT句を指定して、サブプログラムが引数を変更できないようにする必要がある。CALLする側のプログラムとCALLされる側のプログラムの<u>両方</u>がopensource COBOLである場合、BY VALUE句はBY CONTENT句のより高速な代替手段になる。
...
[ページトップへ](#816-cobolとcプログラムの結合)
<!--navi end2-->
<div class="page-break"></div>

<!-- markdown\8-1-7.md -->
<!--navi start1-->
[前へ](#816-cobolとcプログラムの結合)/[目次](https://opensourcecobol.github.io/markdown/TOC.html)/[次へ](#818-コンパイル時のコピーブックの検索)
<!--navi end1-->
### 8.1.7. 重要な環境変数
...
| COB_CONFIG_DIR | opensource COBOLの「構成」ファイルが保存されているフォルダへのパスに設定する。構成ファイルの使用方法については、[8.1.9](#819-コンパイラ構成ファイルの使い方)で説明する。 |
| COB_COPY_DIR | プログラムに必要なCOPYモジュールがプログラムと同じディレクトリに保管されていない場合は、この環境変数をCOPYモジュールが含まれているフォルダに設定する(IBMメインフレームプログラマはこれを「SYSLIB」と認識する)。COPYモジュールの使用に関する追加情報については、[8.1.8](#818-コンパイル時のコピーブックの検索)で説明する。 |
...
| COBCPY | この環境変数は、コンパイラがCOPYモジュールを見つけられる場所を指定する追加手段を提供する(上記のCOB_COPY_DIRも参照)。COPYモジュールの使用に関する追加情報については、[8.1.8](#818-コンパイル時のコピーブックの検索)で説明する。 |
...
<!-- markdown\8-1-8.md -->
<!--navi start1-->
[前へ](#817-重要な環境変数)/[目次](https://opensourcecobol.github.io/markdown/TOC.html)/[次へ](#819-コンパイラ構成ファイルの使い方)
<!--navi end1-->
...
- 「**-I**」コンパイラスイッチ([8.1.2](#812-コンパイルオプション)を参照)で指定されたフォルダ。
- COBCPY環境変数([8.1.7](#817-重要な環境変数)を参照)で指定された各フォルダ。システムに適した区切り文字で区切ることによって、単一のフォルダあるいは複数のフォルダを指定することができる。`34`複数のフォルダを指定した場合、環境変数で指定された順序で検索される。
- COB_COPY_DIR環境変数([8.1.7](#817-重要な環境変数)を参照)で指定されたフォルダ。
...
[ページトップへ](#818-コンパイル時のコピーブックの検索)
<!--navi end2-->
<div class="page-break"></div>

<!-- markdown\8-1-9.md -->
<!--navi start1-->
[前へ](#818-コンパイル時のコピーブックの検索)/[目次](https://opensourcecobol.github.io/markdown/TOC.html)/[次へ](#82-opensource-cobolプログラムの実行)
<!--navi end1-->
...
[ページトップへ](#819-コンパイラ構成ファイルの使い方)
<!--navi end2-->
<div class="page-break"></div>

<!-- markdown\8-2-1.md -->
<!--navi start1-->
[前へ](#819-コンパイラ構成ファイルの使い方)/[目次](https://opensourcecobol.github.io/markdown/TOC.html)/[次へ](#822-cobcrunユーティリティの使用)
<!--navi end1-->
...
[ページトップへ](#82-opensource-cobolプログラムの実行)
<!--navi end2-->
<div class="page-break"></div>

<!-- markdown\8-2-2.md -->
<!--navi start1-->
[前へ](#82-opensource-cobolプログラムの実行)/[目次](https://opensourcecobol.github.io/markdown/TOC.html)/[次へ](#823-プログラムの引数)
<!--navi end1-->
### 8.2.2. 「cobcrun」ユーティリティの使用

「**-m**」オプションを使用してメインプログラムに対してもコンパイラの出力形式を指定することにより、サブルーチンだけでなくすべてのopensource COBOLプログラムの実行可能<u>モジュール</u>を生成できる([8.1.4](#814-動的にロード可能なサブプログラム)で説明したように、これは推奨されているサブルーチンの出力形式オプションである)。
...
[ページトップへ](#822-cobcrunユーティリティの使用)
<!--navi end2-->
<div class="page-break"></div>

<!-- markdown\8-2-3.md -->
<!--navi start1-->
[前へ](#822-cobcrunユーティリティの使用)/[目次](https://opensourcecobol.github.io/markdown/TOC.html)/[次へ](#824-重要な環境変数)
<!--navi end1-->
### 8.2.3. プログラムの引数

プログラムの実行方法に関係なく、プログラムに指定された引数は、[6.4.2](#642-accept文の書き方2--コマンドライン引数の取得)に記載されている次のいずれかを介して取得できる。
...
[ページトップへ](#823-プログラムの引数)
<!--navi end2-->
<div class="page-break"></div>

<!-- markdown\8-2-4.md -->
<!--navi start1-->
[前へ](#823-プログラムの引数)/[目次](https://opensourcecobol.github.io/markdown/TOC.html)/[次へ](#83-組み込みサブルーチン)
<!--navi end1-->
### 8.2.4. 重要な環境変数
...
|COB_SCREEN_ESC | 空白以外の値に設定すると、この変数によりACCEPT文がEscキーを検出できるようになる。詳細については、[表4-8](#414-特殊名段落)で説明している。|
|COB_SCREEN_EXCEPTIONS | この変数を空白以外の値に設定すると、ACCEPT文がEsc、PgUp、およびPgDnキーを検出できるようになる。詳細については、[表4-8](#414-特殊名段落)で説明している。|
...
|COB_SWITCH_n | (n = 1～8)これらの環境変数は、SWITCH-1からSWITCH-8に対応する。「オン」に設定するとアクティブになり、それ以外の値はオフになる。詳細については、[4.1.4](#414-特殊名段落)で説明している。|
...
|DB_HOME |opensource COBOLビルドでBerkeley DB(BDB)パッケージを使用する場合は、この環境変数を使って、プログラムによって開かれたすべての非SORTファイルに関連付けられるロック管理ファイルに関連するフォルダを指定する`35`。この変数を定義すると、READ文([6.33](#633-read))、REWRITE文([6.36](#636-rewrite))、およびWRITE文([6.50](#650-write))でレコードロック機能がアクティブになる`36`。|
...
<!-- markdown\8-3-1.md -->
<!--navi start1-->
[前へ](#824-重要な環境変数)/[目次](https://opensourcecobol.github.io/markdown/TOC.html)/[次へ](#9-サンプルプログラム)
<!--navi end1-->
## 8.3. 組み込みサブルーチン
...
次の表では様々な組み込みサブルーチンについて説明する。明示的に記載されている場合を除き、すべてのサブルーチン引数は必須である。値をRETURN-CODEに返すサブルーチンは、CALL文のRETURNING/GIVING句を利用して、選択したフルワードのバイナリCOMP-5データ項目に結果を返すことができる。これについて[6.7](#67-call)で説明している。
...
[8.3.1.15章](#83115-call-cbl_change_dir-using-directory-path)―**CBL_CHANGE_DIR**を参照
...
[8.3.1.18章](#83118-call-cbl_copy_file-using-src-file-path-dest-file-path)―**CBL_COPY_FILE**を参照
...
[8.3.1.22章](#83122-call-cbl_delete_file-using-file-path)―**CBL_DELETE_FILE**を参照
...
[8.3.1.16章](#83116-call-cbl_check_file_exist-using-file-path-file-info)―**CBL_CHECK_FILE_EXIST**を参照
...
[8.3.1.19章](#83119-call-cbl_create_dir-using-dir-path)―**CBL_CREATE_DIR**を参照
...
[6.1.7章](#617-特殊レジスタ)―**NUMBER-OF-CALL-PARAMETERS**を参照
...
[8.3.1.33章](#83133-call-cbl_oc_nanosleep-using-nanoseconds-to-sleep)―**CBL_OC_NANOSLEEP**を参照
...
[8.3.1.38章](#83138-call-cbl_tolower-using-data-item-by-value-convert-length)―**CBL_TOLOWER**を参照
...
[8.3.1.39章](#83139-call-cbl_toupper-using-data-item-by-value-convert-length)―**CBL_TOUPPER**を参照
...
[8.3.1.2章](#8312-call-cchdir-using-directory-path-result)―**C$CHDIR**を参照
...
[8.3.1.5章](#8315-call-cfileinfo-using-file-path-file-info)―**C$FILEINFO**を参照
...
[8.3.1.3章](#8313-call-ccopy-using-src-file-path-dest-file-path-0)―**C$COPY**を参照
...
[8.3.1.8章](#8318-call-cmakedir-using-dir-path)―**C$MAKEDIR**を参照
...
[8.3.1.34章](#83134-call-cbl_open_file-file-path-access-mode-0-0-handle)―**CBL_OPEN_FILE**を参照
...
*program-pointer*は、終了手続きのアドレスを含むUSAGE PROGRAM-POINTERデータ項目でなければならない。このようなデータ項目を入力する方法については、[6.39.2章](#6392-set文の書き方2--プログラムポインター設定)で説明している。
...
[8.3.1.11章](#83111-call-csleep-using-seconds-to-sleep)―**C$SLEEP**を参照
...
[8.3.1.20章](#83120-call-cbl_create_file-using-file-path-2-0-0-file-handle)―**CBL_CREATE_FILE**を参照
...
[8.3.1.12章](#83112-call-ctolower-using-data-item-by-value-convert-length)―**C$TOLOWER**を参照
...
[8.3.1.13章](#83113-call-ctoupper-using-data-item-by-value-convert-length)―**C$TOUPPER**を参照
...
[ページトップへ](#83-組み込みサブルーチン)
<!--navi end2-->
<div class="page-break"></div>

<!-- markdown\9-1.md -->
<!--navi start1-->
[前へ](#83-組み込みサブルーチン)/[目次](https://opensourcecobol.github.io/markdown/TOC.html)/[次へ](#92-cobdump--16進数文字データダンプサブルーチン)
<!--navi end1-->
# 9. サンプルプログラム
...
<!-- markdown\9-2.md -->
<!--navi start1-->
[前へ](#9-サンプルプログラム)/[目次](https://opensourcecobol.github.io/markdown/TOC.html)/[次へ](#クレジット)
<!--navi end1-->
...
[ページトップへ](#92-cobdump--16進数文字データダンプサブルーチン)
<!--navi end2-->
<div class="page-break"></div>

<!-- markdown\credit.md -->
<!--navi start1-->
[前へ](#92-cobdump--16進数文字データダンプサブルーチン)/[目次](https://opensourcecobol.github.io/markdown/TOC.html)/次へ
<!--navi end1-->
<br>
